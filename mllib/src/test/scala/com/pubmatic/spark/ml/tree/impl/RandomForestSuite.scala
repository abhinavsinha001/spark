...
package com.pubmatic.spark.ml.tree.impl
...
import com.pubmatic.spark.mllib.tree.{DecisionTreeSuite => OldDTSuite, EnsembleTestHelper}
import com.pubmatic.spark.mllib.tree.configuration.{Algo => OldAlgo, QuantileStrategy, Strategy => OldStrategy}
import com.pubmatic.spark.mllib.tree.impurity.{Entropy, Gini, GiniCalculator, Variance}
import com.pubmatic.spark.mllib.util.MLlibTestSparkContext
