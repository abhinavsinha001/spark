...
import com.pubmatic.spark.ml.attribute.{Attribute, AttributeGroup, NominalAttribute, NumericAttribute}
...
import com.pubmatic.spark.ml.util.DefaultReadWriteTest
...
class VectorAssemblerSuite
  ...
  test("assemble") {
    import com.pubmatic.spark.ml.feature.VectorAssembler.assemble
  ...
  test("get lengths functions") {
    import com.pubmatic.spark.ml.feature.VectorAssembler._
