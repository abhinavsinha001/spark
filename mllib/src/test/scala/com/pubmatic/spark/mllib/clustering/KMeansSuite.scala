...
import com.pubmatic.spark.mllib.linalg.{DenseVector, SparseVector, Vector, Vectors}
import com.pubmatic.spark.mllib.util.{LocalClusterSparkContext, MLlibTestSparkContext}
...
class KMeansSuite extends SparkFunSuite with MLlibTestSparkContext {
  ...
  import com.pubmatic.spark.mllib.clustering.KMeans.{K_MEANS_PARALLEL, RANDOM}
