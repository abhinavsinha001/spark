...
package com.pubmatic.spark.mllib.tree.model

import scala.collection.mutable
import com.github.fommil.netlib.BLAS.{getInstance => blas}
import com.pubmatic.spark.mllib.util.Saveable
import org.json4s._
...
import com.pubmatic.spark.mllib.tree.configuration.Algo
import com.pubmatic.spark.mllib.tree.configuration.Algo._
import com.pubmatic.spark.mllib.tree.configuration.EnsembleCombiningStrategy._
import com.pubmatic.spark.mllib.tree.loss.Loss
import com.pubmatic.spark.mllib.util.{Loader, Saveable}
...
object RandomForestModel extends Loader[RandomForestModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "com.pubmatic.spark.mllib.tree.model.RandomForestModel"
  }
...
object GradientBoostedTreesModel extends Loader[GradientBoostedTreesModel] {
  ...
  private object SaveLoadV1_0 {
    // Hard-code class name string in case it changes in the future
    def thisClassName: String = "com.pubmatic.spark.mllib.tree.model.GradientBoostedTreesModel"
  }
...
private[tree] sealed class TreeEnsembleModel(
  ...
  /**
   * Java-friendly version of `com.pubmatic.spark.mllib.tree.model.TreeEnsembleModel.predict`.
   */
...
private[tree] object TreeEnsembleModel extends Logging {
  ...
  object SaveLoadV1_0 {
    ...
    import com.pubmatic.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.{NodeData, constructTrees}
