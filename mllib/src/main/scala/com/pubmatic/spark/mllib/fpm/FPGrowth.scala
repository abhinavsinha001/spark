...
package com.pubmatic.spark.mllib.fpm
...
import com.pubmatic.spark.{HashPartitioner, Partitioner, SparkContext, SparkException}
...
import com.pubmatic.spark.mllib.fpm.FPGrowth._
...
object FPGrowthModel extends Loader[FPGrowthModel[_]] {
  ...
  private[fpm] object SaveLoadV1_0 {
    ...
    private val thisClassName = "com.pubmatic.spark.mllib.fpm.FPGrowthModel"
