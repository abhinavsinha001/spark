...
package com.pubmatic.spark.mllib.tree
...
import com.pubmatic.spark.ml.tree.{DecisionTreeModel => NewDTModel, TreeEnsembleParams => NewRFParams}
import com.pubmatic.spark.ml.tree.impl.{RandomForest => NewRandomForest}
import com.pubmatic.spark.mllib.regression.LabeledPoint
import com.pubmatic.spark.mllib.tree.configuration.Algo._
import com.pubmatic.spark.mllib.tree.configuration.QuantileStrategy._
import com.pubmatic.spark.mllib.tree.configuration.Strategy
import com.pubmatic.spark.mllib.tree.impurity.Impurities
import com.pubmatic.spark.mllib.tree.model._
...
object RandomForest extends Serializable with Logging {
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.RandomForest.trainClassifier`
   */
  @Since("1.2.0")
  def trainClassifier(
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.RandomForest.trainRegressor`
   */
  @Since("1.2.0")
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
