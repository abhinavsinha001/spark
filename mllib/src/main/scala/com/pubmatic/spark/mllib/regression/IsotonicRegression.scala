...
import com.pubmatic.spark.{RangePartitioner, SparkContext}
import com.pubmatic.spark.annotation.Since
import com.pubmatic.spark.api.java.{JavaDoubleRDD, JavaRDD}
...
object IsotonicRegressionModel extends Loader[IsotonicRegressionModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "com.pubmatic.spark.mllib.regression.IsotonicRegressionModel"
