...
package com.pubmatic.spark.mllib.tree.configuration
...
import com.pubmatic.spark.mllib.tree.impurity.{Entropy, Gini, Impurity, Variance}

/**
 * Stores all the configuration options for tree construction
 * @param algo  Learning goal.  Supported:
 *              `com.pubmatic.spark.mllib.tree.configuration.Algo.Classification`,
 *              `com.pubmatic.spark.mllib.tree.configuration.Algo.Regression`
 ...
 *                             `com.pubmatic.spark.mllib.tree.configuration.QuantileStrategy.Sort`
