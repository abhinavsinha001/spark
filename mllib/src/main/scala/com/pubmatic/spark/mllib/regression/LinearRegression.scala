...
import com.pubmatic.spark.mllib.regression.impl.GLMRegressionModel.SaveLoadV1_0
...
import com.pubmatic.spark.mllib.regression.impl.GLMRegressionModel
...
class LinearRegressionModel @Since("1.1.0") (
  ...
  override def save(sc: SparkContext, path: String): Unit = {
    SaveLoadV1_0.save(sc, path, this.getClass.getName, weights, intercept)
  }
}
...
object LinearRegressionModel extends Loader[LinearRegressionModel] {
  ...
  override def load(sc: SparkContext, path: String): LinearRegressionModel = {
    ...
    val classNameV1_0 = "com.pubmatic.spark.mllib.regression.LinearRegressionModel"
