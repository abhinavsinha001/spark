...
import com.pubmatic.spark.ml.classification.{NaiveBayes => NewNaiveBayes}
import com.pubmatic.spark.mllib.linalg.{BLAS, DenseMatrix, DenseVector, Vector}
...
object NaiveBayesModel extends Loader[NaiveBayesModel] {
  ...
  private[mllib] object SaveLoadV2_0 {
    ...
    def thisClassName: String = "com.pubmatic.spark.mllib.classification.NaiveBayesModel"
