...
package com.pubmatic.spark.mllib.recommendation
...
import com.pubmatic.spark.mllib.linalg.BLAS
import com.pubmatic.spark.mllib.rdd.MLPairRDDFunctions._
...
import com.pubmatic.spark.util.BoundedPriorityQueue
...
object MatrixFactorizationModel extends Loader[MatrixFactorizationModel] {
  ...
  import com.pubmatic.spark.mllib.util.Loader._
  ...
  object SaveLoadV1_0 {
    ...
    private[recommendation]
    val thisClassName = "com.pubmatic.spark.mllib.recommendation.MatrixFactorizationModel"
