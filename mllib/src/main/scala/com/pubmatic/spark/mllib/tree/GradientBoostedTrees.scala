...
import com.pubmatic.spark.ml.tree.impl.{GradientBoostedTrees => NewGBT}
...
class GradientBoostedTrees private[spark] (
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.GradientBoostedTrees.run`.
   */
  @Since("1.2.0")
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.GradientBoostedTrees.runWithValidation`.
   */
  @Since("1.4.0")
  def runWithValidation(
...
object GradientBoostedTrees extends Logging {
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.GradientBoostedTrees.train`
   */
  @Since("1.2.0")
  def train(
      input: JavaRDD[LabeledPoint],
