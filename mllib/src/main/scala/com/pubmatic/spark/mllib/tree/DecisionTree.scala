...
object DecisionTree extends Serializable with Logging {
   ...
   * @return DecisionTreeModel that can be used for prediction.
   *
   * @note Using `com.pubmatic.spark.mllib.tree.DecisionTree.trainClassifier`
   * and `com.pubmatic.spark.mllib.tree.DecisionTree.trainRegressor`
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.DecisionTree.trainClassifier`
   */
  @Since("1.1.0")
  def trainClassifier(
  ...
  /**
   * Java-friendly API for `com.pubmatic.spark.mllib.tree.DecisionTree.trainRegressor`
   */
  @Since("1.1.0")
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
