...
import com.pubmatic.spark.ml.classification.NaiveBayesModel
...
import com.pubmatic.spark.ml.classification.{NaiveBayes, NaiveBayesModel}
import com.pubmatic.spark.ml.feature.{IndexToString, RFormula}
import com.pubmatic.spark.ml.r.RWrapperUtils._
