...
import com.pubmatic.spark.ml.Transformer
...
import com.pubmatic.spark.ml.param.shared.{HasInputCol, HasNumFeatures, HasOutputCol}
import com.pubmatic.spark.ml.util._
import com.pubmatic.spark.mllib.feature.{HashingTF => OldHashingTF}
import com.pubmatic.spark.sql.{DataFrame, Dataset}
import com.pubmatic.spark.sql.functions.{col, udf}
import com.pubmatic.spark.sql.types.{ArrayType, StructType}
