...
package com.pubmatic.spark.ml.linalg

import com.pubmatic.spark.ml.linalg
import com.pubmatic.spark.ml.linalg.{DenseVector, SparseVector}
import com.pubmatic.spark.sql.types.UserDefinedType
import com.pubmatic.spark.sql.catalyst.InternalRow
import com.pubmatic.spark.sql.catalyst.expressions.{GenericInternalRow, UnsafeArrayData}
import com.pubmatic.spark.sql.types._

/**
 * User-defined type for [[linalg.Vector]] in [[mllib-local]] which allows easy interaction with SQL
 * via [[com.pubmatic.spark.sql.Dataset]].
 */
private[spark] class VectorUDT extends UserDefinedType[linalg.Vector] {
