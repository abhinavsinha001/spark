...
import com.pubmatic.spark.ml.param.{BooleanParam, Param, ParamMap, ParamValidators}
import com.pubmatic.spark.ml.param.shared.{HasLabelCol, HasPredictionCol, HasWeightCol}
...
import com.pubmatic.spark.sql.types.{DoubleType, FloatType}
