...
package com.pubmatic.spark.ml.param
...
import com.pubmatic.spark.ml.linalg.{JsonMatrixConverter, JsonVectorConverter, Matrix, Vector}
...
class Param[T](val parent: String, val name: String, val doc: String, val isValid: T => Boolean)
   ...
   * columns should be implemented in [[com.pubmatic.spark.ml.PipelineStage.transformSchema()]].
   *
