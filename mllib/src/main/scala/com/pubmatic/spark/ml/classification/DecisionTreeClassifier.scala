...
package com.pubmatic.spark.ml.classification

import com.pubmatic.spark.ml.tree.DecisionTreeModelReadWrite.NodeData
import com.pubmatic.spark.ml.tree.{Node, TreeClassifierParams}
import com.pubmatic.spark.ml.util.{DefaultParamsReadable, DefaultParamsReader, DefaultParamsWriter, Identifiable, MLReadable, MLReader}
import org.apache.hadoop.fs.Path
import org.json4s.{DefaultFormats, JObject}
import org.json4s.JsonDSL._
import com.pubmatic.spark.annotation.Since
import com.pubmatic.spark.ml.feature.LabeledPoint
import com.pubmatic.spark.ml.linalg.{DenseVector, SparseVector, Vector, Vectors}
import com.pubmatic.spark.ml.param.ParamMap
import com.pubmatic.spark.ml.tree._
import com.pubmatic.spark.ml.tree.{DecisionTreeModel, Node, TreeClassifierParams}
import com.pubmatic.spark.ml.tree.DecisionTreeModelReadWrite._
import com.pubmatic.spark.ml.tree.impl.RandomForest
import com.pubmatic.spark.ml.util._
import com.pubmatic.spark.ml.util.Instrumentation.instrumented
import com.pubmatic.spark.mllib.tree.configuration.{Algo => OldAlgo, Strategy => OldStrategy}
import com.pubmatic.spark.mllib.tree.model.{DecisionTreeModel => OldDecisionTreeModel}
import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.sql.{DataFrame, Dataset}
import com.pubmatic.spark.sql.functions.{col, udf}
...
class DecisionTreeClassifier @Since("1.4.0") (
   ...
   * [[com.pubmatic.spark.SparkContext]].
   * Must be at least 1.
   * (default = 10)
   * @group setParam
   */
