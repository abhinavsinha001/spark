...
package com.pubmatic.spark.ml.recommendation
...
import com.pubmatic.spark.{Dependency, Partitioner, ShuffleDependency, SparkContext, SparkException}
...
import com.pubmatic.spark.ml.linalg.BLAS
...
import com.pubmatic.spark.mllib.linalg.CholeskyDecomposition
import com.pubmatic.spark.mllib.optimization.NNLS
...
import com.pubmatic.spark.util.collection.{OpenHashMap, OpenHashSet, SortDataFormat, Sorter}
...
class ALS(@Since("1.4.0") override val uid: String) extends Estimator[ALSModel] with ALSParams
  ...
  import com.pubmatic.spark.ml.recommendation.ALS.Rating
...
object ALS extends DefaultParamsReadable[ALS] with Logging {
   ...
   */
  private[recommendation] type ALSPartitioner = com.pubmatic.spark.HashPartitioner
