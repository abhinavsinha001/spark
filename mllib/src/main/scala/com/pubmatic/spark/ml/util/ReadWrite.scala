...
package com.pubmatic.spark.ml.util
...
import com.pubmatic.spark.ml._
import com.pubmatic.spark.ml.classification.{OneVsRest, OneVsRestModel}
import com.pubmatic.spark.ml.feature.RFormulaModel
import com.pubmatic.spark.ml.param.{ParamPair, Params}
import com.pubmatic.spark.ml.tuning.ValidatorParams
import com.pubmatic.spark.sql.{SparkSession, SQLContext}
import com.pubmatic.spark.util.{Utils, VersionUtils}
 ...
 * all data as [[com.pubmatic.spark.ml.param.Param]] values, then extending this trait will provide
 * a default implementation of writing saved instances of the class.
 * This only handles simple [[com.pubmatic.spark.ml.param.Param]] types; e.g., it will not handle
 * [[com.pubmatic.spark.sql.Dataset]].
 *
...
private[ml] object DefaultParamsWriter {
   ...
   *                  Otherwise, all [[com.pubmatic.spark.ml.param.Param]]s are encoded using
   *                  [[com.pubmatic.spark.ml.param.Param.jsonEncode()]].
   */
  def saveMetadata(
      instance: Params,
      path: String,
...
private[ml] object DefaultParamsReader {
  ...
  case class Metadata(
    ...
    /**
     * Get the JSON value of the [[com.pubmatic.spark.ml.param.Param]] of the given name.
     ...
     * [[com.pubmatic.spark.ml.param.Param.jsonDecode()]].
     *
     * @param skipParams The params included in `skipParams` won't be set. This is useful if some
     *                   params don't implement [[com.pubmatic.spark.ml.param.Param.jsonDecode()]]
