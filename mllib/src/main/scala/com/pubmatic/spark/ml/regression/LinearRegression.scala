...
package com.pubmatic.spark.ml.regression

import scala.collection.mutable
import breeze.linalg.{DenseVector => BDV}
import breeze.optimize.{CachedDiffFunction, LBFGS => BreezeLBFGS, LBFGSB => BreezeLBFGSB, OWLQN => BreezeOWLQN}
import breeze.stats.distributions.StudentsT
import com.pubmatic.spark.ml.param.{Param, ParamValidators}
import com.pubmatic.spark.ml.param.shared.{HasAggregationDepth, HasElasticNetParam, HasFitIntercept, HasLoss, HasMaxIter, HasRegParam, HasSolver, HasStandardization, HasTol, HasWeightCol}
import com.pubmatic.spark.ml.util.{DefaultParamsWriter, MLFormatRegister, MLWriterFormat}
...
import com.pubmatic.spark.ml.{PipelineStage, PredictorParams}
import com.pubmatic.spark.ml.feature.Instance
import com.pubmatic.spark.ml.linalg.{Vector, Vectors}
import com.pubmatic.spark.ml.linalg.BLAS._
import com.pubmatic.spark.ml.optim.WeightedLeastSquares
import com.pubmatic.spark.ml.optim.aggregator.{HuberAggregator, LeastSquaresAggregator}
import com.pubmatic.spark.ml.optim.loss.{L2Regularization, RDDLossFunction}
import com.pubmatic.spark.ml.param.{DoubleParam, Param, ParamMap, ParamValidators}
import com.pubmatic.spark.ml.param.shared._
import com.pubmatic.spark.ml.stat.SummaryBuilderImpl._
...
import com.pubmatic.spark.mllib.regression.{LinearRegressionModel => OldLinearRegressionModel}
...
import com.pubmatic.spark.sql.types.{DataType, DoubleType, StructType}
import com.pubmatic.spark.storage.StorageLevel
import com.pubmatic.spark.util.VersionUtils.majorMinorVersion
...
class LinearRegressionModel private[ml] (
  ...
  /**
   * Returns a [[com.pubmatic.spark.ml.util.GeneralMLWriter]] instance for this ML instance.
   *
