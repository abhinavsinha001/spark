...
import com.pubmatic.spark.ml.optim.aggregator.LogisticAggregator
...
import com.pubmatic.spark.mllib.evaluation.{BinaryClassificationMetrics, MulticlassMetrics}
...
private[classification] trait LogisticRegressionParams extends ProbabilisticClassifierParams
  ...
  import com.pubmatic.spark.ml.classification.LogisticRegression.supportedFamilyNames
...
class LogisticRegressionModel private[spark] (
  ...
  /**
   * Returns a [[com.pubmatic.spark.ml.util.MLWriter]] instance for this ML instance.
   *
