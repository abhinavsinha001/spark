 ...
 * <h2>ML attributes</h2>
 *
 * The ML pipeline API uses {@link com.pubmatic.spark.sql.Dataset}s as ML datasets.
 ...
 * We use {@link com.pubmatic.spark.ml.attribute.Attribute} to describe a scalar ML column, and
 * {@link com.pubmatic.spark.ml.attribute.AttributeGroup} to describe a vector ML column.
 * ML attributes are stored in the metadata field of the column schema.
 */
package com.pubmatic.spark.ml.attribute;
