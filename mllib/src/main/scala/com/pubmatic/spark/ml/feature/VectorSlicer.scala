...
import com.pubmatic.spark.ml.attribute.{Attribute, AttributeGroup}
import com.pubmatic.spark.ml.linalg._
import com.pubmatic.spark.ml.param.{IntArrayParam, ParamMap, StringArrayParam}
import com.pubmatic.spark.ml.param.shared.{HasInputCol, HasOutputCol}
...
final class VectorSlicer @Since("1.5.0") (@Since("1.5.0") override val uid: String)
   ...
   * These names must be specified by ML [[com.pubmatic.spark.ml.attribute.Attribute]]s.
