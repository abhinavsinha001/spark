...
import com.pubmatic.spark.sql.connector.write.{DataWriter, PhysicalWriteInfo, WriterCommitMessage}
import com.pubmatic.spark.sql.connector.write.streaming.{StreamingDataWriterFactory, StreamingWrite}
import com.pubmatic.spark.sql.kafka010.KafkaWriter.validateQuery
