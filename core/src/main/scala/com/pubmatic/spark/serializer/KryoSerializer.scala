...
import com.pubmatic.spark.api.python.PythonBroadcast
import com.pubmatic.spark.internal.Logging
import com.pubmatic.spark.internal.config.Kryo._
import com.pubmatic.spark.internal.io.FileCommitProtocol._
import org.apache.spark.network.util.ByteUnit
import com.pubmatic.spark.scheduler.{CompressedMapStatus, HighlyCompressedMapStatus}
import com.pubmatic.spark.storage._
import com.pubmatic.spark.util.{BoundedPriorityQueue, ByteBufferInputStream, SerializableConfiguration, SerializableJobConf, Utils}
import com.pubmatic.spark.util.collection.CompactBuffer
...
class KryoSerializer(conf: SparkConf)
  extends com.pubmatic.spark.serializer.Serializer
  with Logging
  with Serializable {
...
private[serializer] object KryoSerializer {
  ...
  private lazy val loadableSparkClasses: Seq[Class[_]] = {
    Seq(
      ...
      "com.pubmatic.spark.mllib.clustering.VectorWithNorm",
      "com.pubmatic.spark.mllib.linalg.DenseMatrix",
      "com.pubmatic.spark.mllib.linalg.DenseVector",
      "com.pubmatic.spark.mllib.linalg.Matrix",
      "com.pubmatic.spark.mllib.linalg.SparseMatrix",
      "com.pubmatic.spark.mllib.linalg.SparseVector",
      "com.pubmatic.spark.mllib.linalg.Vector",
      "com.pubmatic.spark.mllib.regression.LabeledPoint",
      "com.pubmatic.spark.mllib.stat.distribution.MultivariateGaussian"
    ).flatMap { name =>
      try {
