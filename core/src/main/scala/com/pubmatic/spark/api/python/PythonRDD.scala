...
import java.{JavaPairRDD, JavaRDD, JavaSparkContext}
...
import com.pubmatic.spark.internal.config.BUFFER_SIZE
import org.apache.spark.network.util.JavaUtils
import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.security.{SocketAuthHelper, SocketAuthServer, SocketFuncServer}
import com.pubmatic.spark.storage.{BroadcastBlockId, StorageLevel}
...
private[spark] object PythonRDD extends Logging {
   ...
   * (see [[com.pubmatic.spark.api.python.Converter]])
   */
  ...
  def newAPIHadoopFile[K, V, F <: NewInputFormat[K, V]](
      ...
      keyConverterClass: String,
      valueConverterClass: String,
      confAsMap: HashMap[String, String],
      batchSize: Int): JavaRDD[Array[Byte]] = {
  ...
  private def getMergedConf(confAsMap: HashMap[String, String],
  ...
  def saveAsSequenceFile[C <: CompressionCodec](
    ...
    saveAsHadoopFile(
      ...
      null, null, null, null, new HashMap(), compressionCodecClass)
  }
   ...
   * [[com.pubmatic.spark.api.python.JavaToWritableConverter]]. Post-conversion types
  ...
  def saveAsNewAPIHadoopFile[F <: NewOutputFormat[_, _]](
      ...
      keyConverterClass: String,
      valueConverterClass: String,
      confAsMap: HashMap[String, String]): Unit = {
    val rdd = SerDeUtil.pythonToPairRDD(pyRDD, batchSerialized)
    val (kc, vc) = getKeyValueTypes(keyClass, valueClass).getOrElse(
      inferKeyValueTypes(rdd, keyConverterClass, valueConverterClass))
    val mergedConf = getMergedConf(confAsMap, pyRDD.context.hadoopConfiguration)
   ...
   * converters or, by default, [[com.pubmatic.spark.api.python.JavaToWritableConverter]].
   */
...
private
class BytesToString extends Function[Array[Byte], String] {
