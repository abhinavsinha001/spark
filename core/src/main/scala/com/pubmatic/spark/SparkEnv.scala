...
import com.pubmatic.spark.api.python.PythonWorkerFactory
...
import com.pubmatic.spark.memory.{MemoryManager, UnifiedMemoryManager}
import com.pubmatic.spark.metrics.{MetricsSystem, MetricsSystemInstances}
import com.pubmatic.spark.network.netty.{NettyBlockTransferService, SparkTransportConf}
import org.apache.spark.network.shuffle.ExternalBlockStoreClient
import com.pubmatic.spark.rpc.{RpcEndpoint, RpcEndpointRef, RpcEnv}
import com.pubmatic.spark.scheduler.{LiveListenerBus, OutputCommitCoordinator}
import com.pubmatic.spark.scheduler.OutputCommitCoordinator.OutputCommitCoordinatorEndpoint
import com.pubmatic.spark.security.CryptoStreamUtils
import com.pubmatic.spark.serializer.{JavaSerializer, Serializer, SerializerManager}
import com.pubmatic.spark.shuffle.ShuffleManager
import com.pubmatic.spark.storage._
import com.pubmatic.spark.util.{RpcUtils, Utils}
...
object SparkEnv extends Logging {
  ...
  private def create(
    ...
    val shortShuffleMgrNames = Map(
      "sort" -> classOf[com.pubmatic.spark.shuffle.sort.SortShuffleManager].getName,
      "tungsten-sort" -> classOf[com.pubmatic.spark.shuffle.sort.SortShuffleManager].getName)
