...
import com.pubmatic.spark.memory.{MemoryConsumer, TaskMemoryManager}
 ...
 *  - [[TaskMemoryManager]] manages the memory allocated by individual
 ...
 *
 *  - [[MemoryConsumer]]s are clients of the TaskMemoryManager and
