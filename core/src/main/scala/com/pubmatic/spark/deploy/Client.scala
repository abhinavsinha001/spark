...
import com.pubmatic.spark.deploy.master.{DriverState, Master}
import com.pubmatic.spark.internal.{config, Logging}
import com.pubmatic.spark.internal.config.Network.RPC_ASK_TIMEOUT
import com.pubmatic.spark.resource.ResourceUtils
import com.pubmatic.spark.rpc.{RpcAddress, RpcEndpointRef, RpcEnv, ThreadSafeRpcEndpoint}
import com.pubmatic.spark.util.{SparkExitCode, ThreadUtils, Utils}
  ...
  override def onStart(): Unit = {
    driverArgs.cmd match {
      case "launch" =>
        ...
        val mainClass = "import com.pubmatic.spark.deploy.worker.DriverWrapper"
