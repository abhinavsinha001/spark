...
import com.pubmatic.spark.{SPARK_VERSION => sparkVersion, SparkConf}
import com.pubmatic.spark.deploy.{Command, DeployMessages, DriverDescription}
import com.pubmatic.spark.deploy.ClientArguments._
...
private[rest] class StandaloneSubmitRequestServlet(
  ...
  private def buildDriverDescription(request: CreateSubmissionRequest): DriverDescription = {
    ...
    val command = new Command(
      "import com.pubmatic.spark.deploy.worker.DriverWrapper",
