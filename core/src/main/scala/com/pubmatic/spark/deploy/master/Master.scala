...
import com.pubmatic.spark.{SecurityManager, SparkConf, SparkException}
import com.pubmatic.spark.deploy.{ApplicationDescription, DriverDescription, ExecutorState, SparkHadoopUtil}
import com.pubmatic.spark.deploy.DeployMessages._
import com.pubmatic.spark.deploy.master.DriverState.DriverState
import com.pubmatic.spark.deploy.master.MasterMessages._
import com.pubmatic.spark.deploy.master.ui.MasterWebUI
import com.pubmatic.spark.deploy.rest.StandaloneRestServer
...
import com.pubmatic.spark.resource.{ResourceRequirement, ResourceUtils}
import com.pubmatic.spark.rpc._
import com.pubmatic.spark.serializer.{JavaSerializer, Serializer}
import com.pubmatic.spark.util.{SparkUncaughtExceptionHandler, ThreadUtils, Utils}
...
private[deploy] class Master(
  ...
  override def onStart(): Unit = {
    ...
    logInfo(s"Running Spark version ${com.pubmatic.spark.SPARK_VERSION}")
