...
import com.pubmatic.spark.internal.config.Tests.TEST_USE_COMPRESSED_OOPS_KEY
 ...
 * [[com.pubmatic.spark.util.collection.SizeTracker]] is that, a
 * [[com.pubmatic.spark.util.collection.SizeTracker]] still uses [[SizeEstimator]] to
