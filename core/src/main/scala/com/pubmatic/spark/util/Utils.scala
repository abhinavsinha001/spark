...
package com.pubmatic.spark.util
...
import com.pubmatic.spark.internal.{Logging, config}
import com.pubmatic.spark.internal.config._
import com.pubmatic.spark.internal.config.Streaming._
...
import com.pubmatic.spark.serializer.{DeserializationStream, SerializationStream, SerializerInstance}
import com.pubmatic.spark.status.api.v1.{StackTrace, ThreadStackTrace}
import com.pubmatic.spark.util.io.ChunkedByteBufferOutputStream
...
private[spark] object Utils extends Logging {
  ...
  */
    ...
    if (groupProviderClassName != "") {
      try {
        val groupMappingServiceProvider = classForName(groupProviderClassName).
          ...
          asInstanceOf[com.pubmatic.spark.security.GroupMappingServiceProvider]
  ...
  private def redact[K, V](redactionPattern: Regex, kvs: Seq[(K, V)]): Seq[(K, V)] = {
    ...
    // information like so:
    // "sun.java.command":"import com.pubmatic.spark.deploy.SparkSubmit ... \
