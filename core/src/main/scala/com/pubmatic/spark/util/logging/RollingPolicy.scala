...
package com.pubmatic.spark.util.logging
...
/**
 * Defines the policy based on which [[com.pubmatic.spark.util.logging.RollingFileAppender]] will
...
/**
 * Defines a [[com.pubmatic.spark.util.logging.RollingPolicy]] by which files will be rolled
