...
import com.pubmatic.spark.{SecurityManager, SparkConf, SparkContext}
...
import com.pubmatic.spark.status.api.v1._
import com.pubmatic.spark.ui.JettyUtils._
import com.pubmatic.spark.ui.env.EnvironmentTab
import com.pubmatic.spark.ui.exec.ExecutorsTab
import com.pubmatic.spark.ui.jobs.{JobsTab, StagesTab}
import com.pubmatic.spark.ui.storage.StorageTab
...
private[spark] object SparkUI {
  ...
  def create(
      ...
      basePath: String,
      startTime: Long,
      appSparkVersion: String = com.pubmatic.spark.SPARK_VERSION): SparkUI = {
