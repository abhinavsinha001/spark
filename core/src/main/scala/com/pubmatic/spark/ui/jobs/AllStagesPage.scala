...
package com.pubmatic.spark.ui.jobs

import javax.servlet.http.HttpServletRequest

import scala.xml.{Attribute, Elem, Node, NodeSeq, Null, Text}
import com.pubmatic.spark.scheduler.Schedulable
import com.pubmatic.spark.status.{AppSummary, PoolData}
import com.pubmatic.spark.status.api.v1.{StageData, StageStatus}
