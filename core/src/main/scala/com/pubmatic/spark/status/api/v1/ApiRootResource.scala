...
import com.pubmatic.spark.SecurityManager
import com.pubmatic.spark.ui.{SparkUI, UIUtils}
...
private[v1] class ApiRootResource extends ApiRequestContext {
  ...
  @GET
  @Path("version")
  def version(): VersionInfo = new VersionInfo(com.pubmatic.spark.SPARK_VERSION)
