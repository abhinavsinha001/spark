 ...
 * a simple Scala wrapper {@link com.pubmatic.spark.util.collection.Sorter}, which is available to
 ...
 *
 * @see com.pubmatic.spark.util.collection.SortDataFormat
 * @see com.pubmatic.spark.util.collection.Sorter
 */
