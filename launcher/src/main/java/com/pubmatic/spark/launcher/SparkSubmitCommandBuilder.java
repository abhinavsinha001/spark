...
class SparkSubmitCommandBuilder extends AbstractCommandBuilder {
  ...
  static {
    ...
    specialClasses.put("com.pubmatic.spark.sql.hive.thriftserver.SparkSQLCLIDriver",
      SparkLauncher.NO_RESOURCE);
    specialClasses.put("com.pubmatic.spark.sql.hive.thriftserver.HiveThriftServer2",
      SparkLauncher.NO_RESOURCE);
  }
  ...
  private boolean isThriftServer(String mainClass) {
    return (mainClass != null &&
      mainClass.equals("com.pubmatic.spark.sql.hive.thriftserver.HiveThriftServer2"));
  }
