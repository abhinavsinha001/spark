...
Refer to the [`IsotonicRegression` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.regression.IsotonicRegression) and [`IsotonicRegressionModel` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.regression.IsotonicRegressionModel) for details on the API.
