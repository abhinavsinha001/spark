...
[`Correlation`](api/scala/index.html#com.pubmatic.spark.ml.stat.Correlation$)
...
<div class="codetabs">
<div data-lang="scala" markdown="1">
Refer to the [`ChiSquareTest` Scala docs](api/scala/index.html#com.pubmatic.spark.ml.stat.ChiSquareTest$) for details on the API.
...
<div class="codetabs">
<div data-lang="scala" markdown="1">
The following example demonstrates using [`Summarizer`](api/scala/index.html#com.pubmatic.spark.ml.stat.Summarizer$)
