...
[L1Updater](api/scala/index.html#com.pubmatic.spark.mllib.optimization.L1Updater).


### Update schemes for distributed SGD
The SGD implementation in
[GradientDescent](api/scala/index.html#com.pubmatic.spark.mllib.optimization.GradientDescent) uses
...
The SGD class
[GradientDescent](api/scala/index.html#com.pubmatic.spark.mllib.optimization.GradientDescent)
...
[L1Updater](api/scala/index.html#com.pubmatic.spark.mllib.optimization.L1Updater) will not work since the 
soft-thresholding logic in L1Updater is designed for gradient descent. See the developer's note.

The L-BFGS method
[LBFGS.runLBFGS](api/scala/index.html#com.pubmatic.spark.mllib.optimization.LBFGS)
...
Refer to the [`LBFGS` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.optimization.LBFGS) and [`SquaredL2Updater` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.optimization.SquaredL2Updater) for details on the API.
