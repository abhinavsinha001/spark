...
Refer to the [`SingularValueDecomposition` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.linalg.SingularValueDecomposition) for details on the API.
...
Refer to the [`PCA` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.feature.PCA) for details on the API.
