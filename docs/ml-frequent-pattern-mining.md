...
Refer to the [Scala API docs](api/scala/index.html#com.pubmatic.spark.ml.fpm.FPGrowth) for more details.
...
<div data-lang="scala" markdown="1">
Refer to the [Scala API docs](api/scala/index.html#com.pubmatic.spark.ml.fpm.PrefixSpan) for more details.
