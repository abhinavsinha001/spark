...
Refer to the [`KMeans` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.clustering.KMeans) and [`Vectors` Scala docs](api/scala/index.html#com.pubmatic.spark.mllib.linalg.Vectors$) for details on the API.
