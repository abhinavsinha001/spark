...
/**
 * Factory methods for [[com.pubmatic.spark.ml.linalg.DenseMatrix]].
 */
@Since("2.0.0")
object DenseMatrix {
...
/**
 * Factory methods for [[com.pubmatic.spark.ml.linalg.SparseMatrix]].
 */
@Since("2.0.0")
object SparseMatrix {
...
/**
 * Factory methods for [[com.pubmatic.spark.ml.linalg.Matrix]].
 */
@Since("2.0.0")
object Matrices {
