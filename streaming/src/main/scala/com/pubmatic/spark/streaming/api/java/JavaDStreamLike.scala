...
import com.pubmatic.spark.api.java.function.{FlatMapFunction, Function, Function2, Function3, PairFlatMapFunction, PairFunction, VoidFunction, VoidFunction2}

import scala.collection.JavaConverters._
import scala.language.implicitConversions
import scala.reflect.ClassTag
import com.pubmatic.spark.api.java.{JavaPairRDD, JavaRDD, JavaRDDLike}
import com.pubmatic.spark.api.java.JavaPairRDD._
import com.pubmatic.spark.api.java.JavaSparkContext.fakeClassTag
import com.pubmatic.spark.api.java.function.{Function => JFunction, Function3 => JFunction3, VoidFunction => JVoidFunction, VoidFunction2 => JVoidFunction2, _}
import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.streaming._
import com.pubmatic.spark.streaming.api.java.JavaDStream._
...
trait JavaDStreamLike[T, This <: JavaDStreamLike[T, This, R], R <: JavaRDDLike[T, R]]
  ...
  def map[U](f: Function[T, U]): JavaDStream[U] = {
   ...
   * of this DStream.
   */
  def reduce(f: Function2[T, T, T]): JavaDStream[T] = dstream.reduce(f)
   ...
   */
  def foreachRDD(foreachFunc: VoidFunction[R]): Unit = {
   ...
   * 'this' DStream will be registered as an output stream and therefore materialized.
   */
  def foreachRDD(foreachFunc: VoidFunction2[R, Time]): Unit = {
   ...
   */
  def transform[U](transformFunc: Function[R, JavaRDD[U]]): JavaDStream[U] = {
   ...
   * on each RDD of 'this' DStream.
   */
  def transform[U](transformFunc: Function2[R, Time, JavaRDD[U]]): JavaDStream[U] = {
    implicit val cm: ClassTag[U] = fakeClassTag
   ...
   * on each RDD of 'this' DStream.
   */
  def transformToPair[K2, V2](transformFunc: Function[R, JavaPairRDD[K2, V2]]):
  JavaPairDStream[K2, V2] = {
   ...
   * on each RDD of 'this' DStream.
   */
  def transformToPair[K2, V2](transformFunc: Function2[R, Time, JavaPairRDD[K2, V2]]):
  JavaPairDStream[K2, V2] = {
    implicit val cmk: ClassTag[K2] = fakeClassTag
    implicit val cmv: ClassTag[V2] = fakeClassTag
  ...
  def transformWith[U, W](
      other: JavaDStream[U],
      transformFunc: Function3[R, JavaRDD[U], Time, JavaRDD[W]]
    ): JavaDStream[W] = {
  ...
  def transformWithToPair[U, K2, V2](
      other: JavaDStream[U],
      transformFunc: Function3[R, JavaRDD[U], Time, JavaPairRDD[K2, V2]]
    ): JavaPairDStream[K2, V2] = {
    implicit val cmu: ClassTag[U] = fakeClassTag
  ...
  def transformWith[K2, V2, W](
      ...
      transformFunc: Function3[R, JavaPairRDD[K2, V2], Time, JavaRDD[W]]
    ): JavaDStream[W] = {
    implicit val cmk2: ClassTag[K2] = fakeClassTag
    implicit val cmv2: ClassTag[V2] = fakeClassTag
  ...
  def transformWithToPair[K2, V2, K3, V3](
      other: JavaPairDStream[K2, V2],
      transformFunc: Function3[R, JavaPairRDD[K2, V2], Time, JavaPairRDD[K3, V3]]
