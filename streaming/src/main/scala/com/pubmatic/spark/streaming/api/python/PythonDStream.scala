...
package com.pubmatic.spark.streaming.api.python
...
import com.pubmatic.spark.api.java._
...
import com.pubmatic.spark.streaming.{Duration, Interval, StreamingContext, Time}
import com.pubmatic.spark.streaming.api.java._
...
private[python] class TransformFunction(@transient var pfunc: PythonTransformFunction)
  extends Function2[JList[JavaRDD[_]], Time, JavaRDD[Array[Byte]]] {
