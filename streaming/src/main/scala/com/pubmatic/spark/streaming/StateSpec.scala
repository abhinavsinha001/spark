...
import com.pubmatic.spark.api.java.function.{Function3, Function4}
import com.pubmatic.spark.{HashPartitioner, Partitioner}
import org.apache.spark.annotation.Experimental
import com.pubmatic.spark.api.java.{JavaPairRDD, JavaUtils, Optional}
import com.pubmatic.spark.api.java.function.{Function3 => JFunction3}
 ...
 * [[com.pubmatic.spark.streaming.dstream.PairDStreamFunctions pair DStream]] (Scala) or a
 * [[com.pubmatic.spark.streaming.api.java.JavaPairDStream JavaPairDStream]] (Java).
 * Use `com.pubmatic.spark.streaming.StateSpec.function()` factory methods
...
sealed abstract class StateSpec[KeyType, ValueType, StateType, MappedType] extends Serializable {
   ...
   * removed; [[com.pubmatic.spark.streaming.State State.isTimingOut()]] set
...
/**
 * :: Experimental ::
 * Builder object for creating instances of `com.pubmatic.spark.streaming.StateSpec`
...
object StateSpec {
  /**
   * Create a [[com.pubmatic.spark.streaming.StateSpec StateSpec]] for setting all the specifications
   * of the `mapWithState` operation on a
   * [[com.pubmatic.spark.streaming.dstream.PairDStreamFunctions pair DStream]].
   *
  ...
  /**
   * Create a [[com.pubmatic.spark.streaming.StateSpec StateSpec]] for setting all
   * the specifications of the `mapWithState` operation on a
   * [[com.pubmatic.spark.streaming.api.java.JavaPairDStream JavaPairDStream]].
   *
  ...
  def function[KeyType, ValueType, StateType, MappedType](mappingFunction:
      Function4[Time, KeyType, Optional[ValueType], State[StateType], Optional[MappedType]]):
    StateSpec[KeyType, ValueType, StateType, MappedType] = {
...
/** Internal implementation of [[com.pubmatic.spark.streaming.StateSpec]] interface. */
private[streaming]
