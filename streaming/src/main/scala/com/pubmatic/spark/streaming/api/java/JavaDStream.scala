...
/**
 * A Java-friendly interface to [[com.pubmatic.spark.streaming.dstream.DStream]], the basic
 ...
 * [[com.pubmatic.spark.streaming.api.java.JavaPairDStream]].
 */
class JavaDStream[T](val dstream: DStream[T])(implicit val classTag: ClassTag[T])
  ...
  def filter(f: Function[T, java.lang.Boolean]): JavaDStream[T] =
...
object JavaDStream {
  /**
   * Convert a scala [[com.pubmatic.spark.streaming.dstream.DStream]] to a Java-friendly
   * [[com.pubmatic.spark.streaming.api.java.JavaDStream]].
   */
