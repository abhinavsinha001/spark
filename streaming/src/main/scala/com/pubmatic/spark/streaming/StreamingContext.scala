...
import com.pubmatic.spark.input.FixedLengthBinaryInputFormat
import com.pubmatic.spark.internal.Logging
import com.pubmatic.spark.rdd.{RDD, RDDOperationScope}
import com.pubmatic.spark.scheduler.LiveListenerBus
import com.pubmatic.spark.serializer.SerializationDebugger
import com.pubmatic.spark.storage.StorageLevel
import com.pubmatic.spark.streaming.StreamingContextState._
import com.pubmatic.spark.streaming.dstream._
import com.pubmatic.spark.streaming.receiver.Receiver
import com.pubmatic.spark.streaming.scheduler.{ExecutorAllocationManager, JobScheduler, StreamingListener, StreamingListenerStreamingStarted}
import com.pubmatic.spark.streaming.ui.{StreamingJobProgressListener, StreamingTab}
import com.pubmatic.spark.util.{CallSite, ShutdownHookManager, ThreadUtils, Utils}

/**
 * Main entry point for Spark Streaming functionality. It provides methods used to create
 * [[com.pubmatic.spark.streaming.dstream.DStream]]s from various input sources. It can be either
...
class StreamingContext private[streaming] (
  ...
  /**
   * Add a [[com.pubmatic.spark.streaming.scheduler.StreamingListener]] object for
