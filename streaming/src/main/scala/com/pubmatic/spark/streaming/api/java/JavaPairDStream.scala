...
import com.pubmatic.spark.api.java.function.{FlatMapFunction, Function, Function2}
...
import com.pubmatic.spark.api.java.{JavaPairRDD, JavaSparkContext, JavaUtils, Optional}
import com.pubmatic.spark.api.java.JavaPairRDD._
import com.pubmatic.spark.api.java.JavaSparkContext.fakeClassTag
import com.pubmatic.spark.api.java.function.{FlatMapFunction, Function => JFunction}
import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.storage.StorageLevel
import com.pubmatic.spark.streaming._
import com.pubmatic.spark.streaming.dstream.DStream
...
class JavaPairDStream[K, V](val dstream: DStream[(K, V)])(
  ...
  def filter(f: Function[(K, V), java.lang.Boolean]): JavaPairDStream[K, V] =
  ...
  def combineByKey[C](createCombiner: Function[V, C],
                      ...
                      mergeCombiners: Function2[C, C, C],
  ...
  def reduceByKeyAndWindow(
                            ...
                            slideDuration: Duration,
                            numPartitions: Int,
                            filterFunc: Function[(K, V), java.lang.Boolean]
    ): JavaPairDStream[K, V] = {
  ...
  private def convertUpdateStateFunction[S](in: Function2[JList[V], Optional[S], Optional[S]]):
   ...
   * @tparam S State type
   */
  def updateStateByKey[S](updateFunc: Function2[JList[V], Optional[S], Optional[S]])
  : JavaPairDStream[K, S] = {
  ...
  def updateStateByKey[S](
                           updateFunc: Function2[JList[V], Optional[S], Optional[S]],
                           numPartitions: Int)
  : JavaPairDStream[K, S] = {
    implicit val cm: ClassTag[S] = fakeClassTag
