...
import com.pubmatic.spark.streaming.{Checkpoint, CheckpointWriter, Time}
import com.pubmatic.spark.streaming.api.python.PythonDStream
import com.pubmatic.spark.streaming.util.RecurringTimer
import com.pubmatic.spark.util.{Clock, EventLoop, ManualClock, Utils}
...
class JobGenerator(jobScheduler: JobScheduler) extends Logging {
  ...
  val clock = {
    val clockClass = ssc.sc.conf.get(
      "spark.streaming.clock", "com.pubmatic.spark.util.SystemClock")
    try {
