...
package com.pubmatic.spark.streamingtest
...
class ImplicitSuite {
  ...
  def mockDStream[T]: com.pubmatic.spark.streaming.dstream.DStream[T] = null

  def testToPairDStreamFunctions(): Unit = {
    val dstream: com.pubmatic.spark.streaming.dstream.DStream[(Int, Int)] = mockDStream
    dstream.groupByKey()
  }
}
