...
import com.pubmatic.spark.{SparkConf, SparkContext, SparkFunSuite, TestUtils}
...
import com.pubmatic.spark.streaming.scheduler._
import com.pubmatic.spark.util.{Clock, ManualClock, MutableURLClassLoader, ResetSystemProperties, Utils}
...
class CheckpointSuite extends TestSuiteBase with LocalStreamingContext with DStreamCheckpointTester
  ...
  test("basic rdd checkpoints + dstream graph checkpoint recovery") {
    ...
    conf.set("spark.streaming.clock", "com.pubmatic.spark.util.ManualClock")
