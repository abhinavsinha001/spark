...
package com.pubmatic.spark.streaming.scheduler
...
import com.pubmatic.spark.scheduler.{SparkListener, SparkListenerTaskStart, TaskLocality}
import com.pubmatic.spark.scheduler.TaskLocality.TaskLocality
import com.pubmatic.spark.storage.{StorageLevel, StreamBlockId}
import com.pubmatic.spark.streaming._
import com.pubmatic.spark.streaming.dstream.{ConstantInputDStream, ReceiverInputDStream}
import com.pubmatic.spark.streaming.receiver._
...
class ReceiverTrackerSuite extends TestSuiteBase {
  ...
  test("SPARK-11063: TaskSetManager should use Receiver RDD's preferredLocations") {
    ...
    val _conf = conf.clone.set("spark.streaming.clock", "com.pubmatic.spark.util.ManualClock")
