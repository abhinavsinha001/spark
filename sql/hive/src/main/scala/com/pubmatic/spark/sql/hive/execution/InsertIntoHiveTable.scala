...
import com.pubmatic.spark.sql.catalyst.catalog.{CatalogTable, CatalogTableType, ExternalCatalog, ExternalCatalogUtils}
...
import com.pubmatic.spark.sql.hive.HiveShim.{ShimFileSinkDesc => FileSinkDesc}
import com.pubmatic.spark.sql.hive.client.HiveClientImpl
 ...
 * as defined in `com.pubmatic.spark.sql.execution.datasources.FileFormatWriter`.
 *
