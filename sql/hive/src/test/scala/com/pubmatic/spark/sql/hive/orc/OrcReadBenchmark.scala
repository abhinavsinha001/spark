...
import com.pubmatic.spark.sql.execution.benchmark.SqlBasedBenchmark
...
object OrcReadBenchmark extends SqlBasedBenchmark {
  ...
  private val NATIVE_ORC_FORMAT = classOf[com.pubmatic.spark.sql.execution.datasources.orc.OrcFileFormat].getCanonicalName
  private val HIVE_ORC_FORMAT = classOf[com.pubmatic.spark.sql.hive.orc.OrcFileFormat].getCanonicalName
