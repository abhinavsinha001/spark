...
import com.pubmatic.spark.sql.catalyst.expressions.NamedExpression
import com.pubmatic.spark.sql.catalyst.plans.logical.{Distinct, Filter, Project, SubqueryAlias}
import com.pubmatic.spark.sql.hive.test.TestHiveSingleton
import com.pubmatic.spark.sql.internal.SQLConf.OPTIMIZER_METADATA_ONLY
