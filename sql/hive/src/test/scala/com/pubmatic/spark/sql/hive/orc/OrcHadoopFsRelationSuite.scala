...
import com.pubmatic.spark.sql.sources.HadoopFsRelationTest
...
class OrcHadoopFsRelationSuite extends HadoopFsRelationTest {
  ...
  override val dataSourceName: String =
    classOf[com.pubmatic.spark.sql.execution.datasources.orc.OrcFileFormat].getCanonicalName
...
class HiveOrcHadoopFsRelationSuite extends OrcHadoopFsRelationSuite {
  override val dataSourceName: String =
    classOf[com.pubmatic.spark.sql.hive.orc.OrcFileFormat].getCanonicalName
}
