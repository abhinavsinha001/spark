...
import com.pubmatic.spark.sql.TestingUDT.{IntervalData, IntervalUDT}
import com.pubmatic.spark.sql.execution.datasources.orc.OrcSuite
  ...
  override def beforeAll(): Unit = {
    ...
    spark.sql(
      s"""CREATE TEMPORARY VIEW normal_orc_source
         |USING com.pubmatic.spark.sql.hive.orc
         |OPTIONS (
