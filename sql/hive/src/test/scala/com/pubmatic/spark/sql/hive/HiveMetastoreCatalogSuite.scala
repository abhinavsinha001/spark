...
import com.pubmatic.spark.sql.catalyst.catalog.CatalogTableType
import com.pubmatic.spark.sql.catalyst.parser.CatalystSqlParser
import com.pubmatic.spark.sql.catalyst.plans.logical.SubqueryAlias
import com.pubmatic.spark.sql.hive.test.TestHiveSingleton
import com.pubmatic.spark.sql.internal.{HiveSerDe, SQLConf}
import com.pubmatic.spark.sql.test.{ExamplePointUDT, SQLTestUtils}
...
class DataSourceWithHiveMetastoreCatalogSuite
  ...
  Seq(
    ...
    "com.pubmatic.spark.sql.hive.orc" -> ((
      "org.apache.hadoop.hive.ql.io.orc.OrcInputFormat",
      "org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat",
      "org.apache.hadoop.hive.ql.io.orc.OrcSerde"
    )),

    "com.pubmatic.spark.sql.execution.datasources.orc.OrcFileFormat" -> ((
      "org.apache.hadoop.hive.ql.io.orc.OrcInputFormat",
      "org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat",
      "org.apache.hadoop.hive.ql.io.orc.OrcSerde"
    ))
