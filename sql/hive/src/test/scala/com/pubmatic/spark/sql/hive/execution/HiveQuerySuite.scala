...
import com.pubmatic.spark.sql.catalyst.expressions.Cast
import com.pubmatic.spark.sql.catalyst.parser.ParseException
import com.pubmatic.spark.sql.catalyst.plans.logical.Project
import com.pubmatic.spark.sql.execution.joins.BroadcastNestedLoopJoinExec
import com.pubmatic.spark.sql.hive._
import com.pubmatic.spark.sql.hive.test.{HiveTestJars, TestHive}
  ...
  test("CREATE TEMPORARY FUNCTION") {
    ...
    sql(
      """CREATE TEMPORARY FUNCTION udtf_count2 AS
        |'com.pubmatic.spark.sql.hive.execution.GenericUDTFCount2'
      """.stripMargin)
