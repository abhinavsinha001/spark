...
public class AvroPrimitives extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder();
  }
  
  /** Creates a new AvroPrimitives RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder(other);
  }
  
  /** Creates a new AvroPrimitives RecordBuilder by copying an existing AvroPrimitives instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroPrimitives>
    ...
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.SCHEMA$);
      if (isValidValue(fields()[0], other.bool_column)) {
        this.bool_column = data().deepCopy(fields()[0].schema(), other.bool_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'bool_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setBoolColumn(boolean value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearBoolColumn() {
    ...
    /** Sets the value of the 'int_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setIntColumn(int value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearIntColumn() {
    ...
    /** Sets the value of the 'long_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setLongColumn(long value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearLongColumn() {
    ...
    /** Sets the value of the 'float_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setFloatColumn(float value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearFloatColumn() {
    ...
    /** Sets the value of the 'double_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setDoubleColumn(double value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearDoubleColumn() {
    ...
    /** Sets the value of the 'binary_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setBinaryColumn(java.nio.ByteBuffer value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearBinaryColumn() {
      binary_column = null;
    ...
    /** Sets the value of the 'string_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder setStringColumn(java.lang.String value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroPrimitives.Builder clearStringColumn() {
      string_column = null;
