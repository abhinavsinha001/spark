...
public class ParquetAvroCompat extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> complex_column;
   ...
   */
  public ParquetAvroCompat(java.util.List<java.lang.String> strings_column, java.util.Map<java.lang.String,java.lang.Integer> string_to_int_column, java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> complex_column) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: complex_column = (java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> getComplexColumn() {
   ...
   * @param value the value to set.
   */
  public void setComplexColumn(java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> value) {
    this.complex_column = value;
  }

  /** Creates a new ParquetAvroCompat RecordBuilder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder();
  }
  
  /** Creates a new ParquetAvroCompat RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder(other);
  }
  
  /** Creates a new ParquetAvroCompat RecordBuilder by copying an existing ParquetAvroCompat instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ParquetAvroCompat>
    ...
    private java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> complex_column;

    /** Creates a new Builder */
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.SCHEMA$);
      if (isValidValue(fields()[0], other.strings_column)) {
        this.strings_column = data().deepCopy(fields()[0].schema(), other.strings_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'strings_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder setStringsColumn(java.util.List<java.lang.String> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder clearStringsColumn() {
      strings_column = null;
    ...
    /** Sets the value of the 'string_to_int_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder setStringToIntColumn(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder clearStringToIntColumn() {
    ...
    /** Sets the value of the 'complex_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder setComplexColumn(java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.ParquetAvroCompat.Builder clearComplexColumn() {
      complex_column = null;
    ...
    public ParquetAvroCompat build() {
      try {
        ...
        record.complex_column = fieldSetFlags()[2] ? this.complex_column : (java.util.Map<java.lang.String,java.util.List<com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested>>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
