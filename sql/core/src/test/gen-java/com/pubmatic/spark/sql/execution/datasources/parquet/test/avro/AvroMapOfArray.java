...
public class AvroMapOfArray extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroMapOfArray\",\"namespace\":\"com.pubmatic.spark.sql.execution.datasources.parquet.test.avro\",\"fields\":[{\"name\":\"string_to_ints_column\",\"type\":{\"type\":\"map\",\"values\":{\"type\":\"array\",\"items\":\"int\"},\"avro.java.string\":\"String\"}}]}");
  ...
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder();
  }
  
  /** Creates a new AvroMapOfArray RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder(other);
  }
  
  /** Creates a new AvroMapOfArray RecordBuilder by copying an existing AvroMapOfArray instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroMapOfArray>
    ...
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.SCHEMA$);
      if (isValidValue(fields()[0], other.string_to_ints_column)) {
        this.string_to_ints_column = data().deepCopy(fields()[0].schema(), other.string_to_ints_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'string_to_ints_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder setStringToIntsColumn(java.util.Map<java.lang.String,java.util.List<java.lang.Integer>> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroMapOfArray.Builder clearStringToIntsColumn() {
