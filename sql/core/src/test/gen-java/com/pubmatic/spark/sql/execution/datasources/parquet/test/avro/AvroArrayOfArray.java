...
public class AvroArrayOfArray extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroArrayOfArray\",\"namespace\":\"com.pubmatic.spark.sql.execution.datasources.parquet.test.avro\",\"fields\":[{\"name\":\"int_arrays_column\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":\"int\"}}}]}");
  ...
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder();
  }
  
  /** Creates a new AvroArrayOfArray RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder(other);
  }
  
  /** Creates a new AvroArrayOfArray RecordBuilder by copying an existing AvroArrayOfArray instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroArrayOfArray>
    ...
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.SCHEMA$);
      if (isValidValue(fields()[0], other.int_arrays_column)) {
        this.int_arrays_column = data().deepCopy(fields()[0].schema(), other.int_arrays_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'int_arrays_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder setIntArraysColumn(java.util.List<java.util.List<java.lang.Integer>> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroArrayOfArray.Builder clearIntArraysColumn() {
