...
public class AvroNonNullableArrays extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder();
  }
  
  /** Creates a new AvroNonNullableArrays RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder(other);
  }
  
  /** Creates a new AvroNonNullableArrays RecordBuilder by copying an existing AvroNonNullableArrays instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroNonNullableArrays>
    ...
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.SCHEMA$);
      if (isValidValue(fields()[0], other.strings_column)) {
        this.strings_column = data().deepCopy(fields()[0].schema(), other.strings_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'strings_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder setStringsColumn(java.util.List<java.lang.String> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder clearStringsColumn() {
      strings_column = null;
    ...
    /** Sets the value of the 'maybe_ints_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder setMaybeIntsColumn(java.util.List<java.lang.Integer> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.AvroNonNullableArrays.Builder clearMaybeIntsColumn() {
