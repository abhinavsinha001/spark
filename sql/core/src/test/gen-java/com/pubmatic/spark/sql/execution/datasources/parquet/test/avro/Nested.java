...
public class Nested extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Nested\",\"namespace\":\"com.pubmatic.spark.sql.execution.datasources.parquet.test.avro\",\"fields\":[{\"name\":\"nested_ints_column\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"nested_string_column\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  ...
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder newBuilder() {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder();
  }
  
  /** Creates a new Nested RecordBuilder by copying an existing Builder */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder(other);
  }
  
  /** Creates a new Nested RecordBuilder by copying an existing Nested instance */
  public static com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder newBuilder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested other) {
    return new com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Nested>
    ...
    private Builder() {
      super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder other) {
      super(other);
    ...
    private Builder(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested other) {
            super(com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.SCHEMA$);
      if (isValidValue(fields()[0], other.nested_ints_column)) {
        this.nested_ints_column = data().deepCopy(fields()[0].schema(), other.nested_ints_column);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'nested_ints_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder setNestedIntsColumn(java.util.List<java.lang.Integer> value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder clearNestedIntsColumn() {
    ...
    /** Sets the value of the 'nested_string_column' field */
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder setNestedStringColumn(java.lang.String value) {
    ...
    public com.pubmatic.spark.sql.execution.datasources.parquet.test.avro.Nested.Builder clearNestedStringColumn() {
