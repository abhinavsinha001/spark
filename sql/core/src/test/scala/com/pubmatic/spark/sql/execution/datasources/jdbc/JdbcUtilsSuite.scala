...
class JdbcUtilsSuite extends SparkFunSuite {
  ...
  val caseSensitive = com.pubmatic.spark.sql.catalyst.analysis.caseSensitiveResolution
  val caseInsensitive = com.pubmatic.spark.sql.catalyst.analysis.caseInsensitiveResolution
