...
import com.pubmatic.spark.sql.{AnalysisException, DataFrame, SQLContext}
import com.pubmatic.spark.sql.catalyst.analysis.{AnalysisSuite, NamedRelation}
import com.pubmatic.spark.sql.catalyst.expressions.{AttributeReference, EqualTo, Literal}
import com.pubmatic.spark.sql.catalyst.plans.logical._
import com.pubmatic.spark.sql.connector.catalog.{Table, TableCapability, TableProvider}
...
import com.pubmatic.spark.sql.execution.datasources.v2.{DataSourceV2Relation, TableCapabilityCheck}
import com.pubmatic.spark.sql.execution.streaming.{Offset, Source, StreamingRelation, StreamingRelationV2}
import com.pubmatic.spark.sql.sources.StreamSourceProvider
import com.pubmatic.spark.sql.test.SharedSparkSession
import com.pubmatic.spark.sql.types.{LongType, StringType, StructType}
