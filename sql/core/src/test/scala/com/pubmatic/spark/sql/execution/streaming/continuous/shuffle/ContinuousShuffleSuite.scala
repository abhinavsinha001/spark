...
package com.pubmatic.spark.sql.execution.streaming.continuous.shuffle

import java.util.UUID

import scala.language.implicitConversions

import com.pubmatic.spark.{HashPartitioner, TaskContext, TaskContextImpl}
import com.pubmatic.spark.rpc.RpcEndpointRef
import com.pubmatic.spark.sql.catalyst.expressions.{GenericInternalRow, UnsafeProjection}
import com.pubmatic.spark.sql.streaming.StreamTest
import com.pubmatic.spark.sql.types.{DataType, IntegerType, StringType}
