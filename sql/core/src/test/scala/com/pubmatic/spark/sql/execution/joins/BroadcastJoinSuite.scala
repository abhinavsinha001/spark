...
package com.pubmatic.spark.sql.execution.joins

import scala.reflect.ClassTag

import com.pubmatic.spark.AccumulatorSuite
import com.pubmatic.spark.sql.{Dataset, QueryTest, Row, SparkSession}
import com.pubmatic.spark.sql.catalyst.expressions.{BitwiseAnd, BitwiseOr, Cast, Literal, ShiftLeft}
import com.pubmatic.spark.sql.catalyst.plans.logical.BROADCAST
import com.pubmatic.spark.sql.execution.{SparkPlan, WholeStageCodegenExec}
import com.pubmatic.spark.sql.execution.columnar.InMemoryTableScanExec
import com.pubmatic.spark.sql.execution.exchange.EnsureRequirements
...
import com.pubmatic.spark.sql.types.{LongType, ShortType}
 ...
 * unsafe map in [[com.pubmatic.spark.sql.execution.joins.UnsafeHashedRelation]] is not triggered
...
class BroadcastJoinSuite extends QueryTest with SQLTestUtils {
  ...
  test("broadcast hint in SQL") {
    import com.pubmatic.spark.sql.catalyst.plans.logical.Join
