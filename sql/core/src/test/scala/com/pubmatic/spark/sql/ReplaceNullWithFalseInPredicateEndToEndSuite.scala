...
import com.pubmatic.spark.sql.catalyst.expressions.{CaseWhen, If, Literal}
import com.pubmatic.spark.sql.execution.LocalTableScanExec
import com.pubmatic.spark.sql.functions.{lit, when}
