...
import com.pubmatic.spark.sql.catalog.{Column, Database, Function, Table}
import com.pubmatic.spark.sql.catalyst.{FunctionIdentifier, ScalaReflection, TableIdentifier}
import com.pubmatic.spark.sql.catalyst.catalog._
import com.pubmatic.spark.sql.catalyst.expressions.{Expression, ExpressionInfo}
...
/**
 * Tests for the user-facing [[com.pubmatic.spark.sql.catalog.Catalog]].
 */
