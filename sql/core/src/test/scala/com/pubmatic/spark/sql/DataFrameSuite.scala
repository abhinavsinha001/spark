...
import com.pubmatic.spark.scheduler.{SparkListener, SparkListenerJobEnd}
import com.pubmatic.spark.sql.catalyst.TableIdentifier
import com.pubmatic.spark.sql.catalyst.encoders.RowEncoder
import com.pubmatic.spark.sql.catalyst.expressions.Uuid
import com.pubmatic.spark.sql.catalyst.optimizer.ConvertToLocalRelation
import com.pubmatic.spark.sql.catalyst.plans.logical.{OneRowRelation, Union}
import com.pubmatic.spark.sql.execution.{FilterExec, QueryExecution, WholeStageCodegenExec}
import com.pubmatic.spark.sql.execution.aggregate.HashAggregateExec
import com.pubmatic.spark.sql.execution.exchange.{BroadcastExchangeExec, ReusedExchangeExec, ShuffleExchangeExec}
import com.pubmatic.spark.sql.functions._
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.test.{ExamplePoint, ExamplePointUDT, SharedSparkSession}
import com.pubmatic.spark.sql.test.SQLTestData.{DecimalData, NullStrings, TestData2}
import com.pubmatic.spark.sql.types._
import com.pubmatic.spark.util.Utils
import com.pubmatic.spark.util.random.XORShiftRandom
...
class DataFrameSuite extends QueryTest with SharedSparkSession {
  ...
  test("SPARK-8072: Better Exception for Duplicate Columns") {
    ...
    val f = intercept[com.pubmatic.spark.sql.AnalysisException] {
