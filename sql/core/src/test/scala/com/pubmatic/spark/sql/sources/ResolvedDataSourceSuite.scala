...
package com.pubmatic.spark.sql.sources
...
class ResolvedDataSourceSuite extends SharedSparkSession {
  ...
  test("jdbc") {
    assert(
      ...
      classOf[com.pubmatic.spark.sql.execution.datasources.jdbc.JdbcRelationProvider])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.execution.datasources.jdbc") ===
      classOf[com.pubmatic.spark.sql.execution.datasources.jdbc.JdbcRelationProvider])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.jdbc") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.jdbc.JdbcRelationProvider])
  }
  ...
  test("json") {
    assert(
      ...
      classOf[com.pubmatic.spark.sql.execution.datasources.json.JsonFileFormat])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.execution.datasources.json") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.json.JsonFileFormat])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.json") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.json.JsonFileFormat])
  }
  ...
  test("parquet") {
    assert(
      ...
      classOf[com.pubmatic.spark.sql.execution.datasources.parquet.ParquetFileFormat])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.execution.datasources.parquet") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.parquet.ParquetFileFormat])
    assert(
      getProvidingClass("com.pubmatic.spark.sql.parquet") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.parquet.ParquetFileFormat])
  }
  ...
  test("csv") {
    assert(
      getProvidingClass("csv") ===
        classOf[com.pubmatic.spark.sql.execution.datasources.csv.CSVFileFormat])
    assert(
  ...
  test("avro: show deploy guide for loading the external avro module") {
    Seq("avro", "com.pubmatic.spark.sql.avro").foreach { provider =>
