...
import com.pubmatic.spark.sql.execution.datasources.orc.OrcShimUtils.VectorizedRowBatchWrap;
import com.pubmatic.spark.sql.execution.vectorized.ColumnVectorUtils;
...
public class OrcColumnarBatchReader extends RecordReader<Void, ColumnarBatch> {
  ...
  private com.pubmatic.spark.sql.vectorized.ColumnVector[] orcVectorWrappers;
  ...
  public void initBatch(
    ...
    orcVectorWrappers = new com.pubmatic.spark.sql.vectorized.ColumnVector[resultSchema.length()];
