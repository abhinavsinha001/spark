...
package com.pubmatic.spark.sql.expressions.javalang;

import com.pubmatic.spark.api.java.function.MapFunction;
import com.pubmatic.spark.sql.TypedColumn;
import com.pubmatic.spark.sql.execution.aggregate.TypedAverage;
import com.pubmatic.spark.sql.execution.aggregate.TypedCount;
import com.pubmatic.spark.sql.execution.aggregate.TypedSumDouble;
import com.pubmatic.spark.sql.execution.aggregate.TypedSumLong;

/**
 * Type-safe functions available for {@link com.pubmatic.spark.sql.Dataset} operations in Java.
 *
 * Scala users should use {@link com.pubmatic.spark.sql.expressions.scalalang.typed}.
 *
 * @since 2.0.0
