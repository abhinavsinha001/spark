...
import com.pubmatic.spark.{InterruptibleIterator, Partition, SparkContext, TaskContext}
import com.pubmatic.spark.rdd.{EmptyRDD, PartitionwiseSampledRDD, RDD}
...
import com.pubmatic.spark.sql.execution.metric.SQLMetrics
import com.pubmatic.spark.sql.types.{LongType, StructType}
import com.pubmatic.spark.util.ThreadUtils
import com.pubmatic.spark.util.random.{BernoulliCellSampler, PoissonSampler}
 ...
 */
case class RangeExec(range: com.pubmatic.spark.sql.catalyst.plans.logical.Range)
  ...
  override def doCanonicalize(): SparkPlan = {
    RangeExec(range.canonicalized.asInstanceOf[com.pubmatic.spark.sql.catalyst.plans.logical.Range])
  }
 ...
 * [[com.pubmatic.spark.sql.catalyst.plans.logical.Union.maxRowsPerPartition]].
 */
