...
import com.pubmatic.spark.sql.execution.metric.{SQLMetric, SQLShuffleReadMetricsReporter}
...
/**
 * This is a specialized version of [[com.pubmatic.spark.sql.execution.ShuffledRowRDD]]. This is used
