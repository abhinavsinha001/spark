...
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, GenericRowWithSchema}
import com.pubmatic.spark.sql.catalyst.util.StringUtils
import com.pubmatic.spark.sql.connector.catalog.CatalogV2Implicits.NamespaceHelper
