...
package com.pubmatic.spark.sql.expressions.scalalang

import com.pubmatic.spark.sql._
import com.pubmatic.spark.sql.execution.aggregate._

/**
 * Type-safe functions available for `Dataset` operations in Scala.
 *
 * Java users should use [[com.pubmatic.spark.sql.expressions.javalang.typed]].
 *
 * @since 2.0.0
 */
