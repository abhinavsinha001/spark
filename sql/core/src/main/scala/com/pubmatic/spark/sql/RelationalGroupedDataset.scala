...
import com.pubmatic.spark.sql.catalyst.analysis.{Star, UnresolvedAlias, UnresolvedAttribute, UnresolvedFunction}
import com.pubmatic.spark.sql.catalyst.encoders.encoderFor
...
import com.pubmatic.spark.sql.execution.aggregate.TypedAggregateExpression
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.types.{StructType, TypeCollection}
...
class RelationalGroupedDataset protected[sql](
   ...
   *
   * The available aggregate methods are defined in [[com.pubmatic.spark.sql.functions]].
   *
   * {{{
   *   // Selects the age of the oldest employee and the aggregate expense for each department
   *
