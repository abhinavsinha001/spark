...
import com.pubmatic.spark.api.java.function.{CoGroupFunction, FlatMapGroupsFunction, MapFunction, MapGroupsFunction, ReduceFunction}

import scala.collection.JavaConverters._
import com.pubmatic.spark.api.java.function._
import com.pubmatic.spark.sql.catalyst.encoders.{ExpressionEncoder, encoderFor}
import com.pubmatic.spark.sql.catalyst.expressions.{Alias, Attribute, CreateStruct}
import com.pubmatic.spark.sql.catalyst.plans.logical._
import com.pubmatic.spark.sql.execution.QueryExecution
import com.pubmatic.spark.sql.expressions.ReduceAggregator
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.streaming.{GroupState, GroupStateTimeout, OutputMode}
...
class KeyValueGroupedDataset[K, V] private[sql](
   ...
   * `com.pubmatic.spark.sql.expressions#Aggregator`.
   *
   ...
   * See [[com.pubmatic.spark.sql.streaming.GroupState]] for more details.
   *
