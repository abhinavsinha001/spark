...
import com.pubmatic.spark.sql.catalyst.analysis.{NamespaceAlreadyExistsException, NoSuchNamespaceException, NoSuchTableException, TableAlreadyExistsException}
import com.pubmatic.spark.sql.catalyst.catalog.{BucketSpec, CatalogDatabase, CatalogTable, CatalogTableType, CatalogUtils, SessionCatalog}
import com.pubmatic.spark.sql.connector.catalog.{CatalogManager, CatalogV2Util, Identifier, NamespaceChange, SupportsNamespaces, Table, TableCatalog, TableChange, V1Table}
import com.pubmatic.spark.sql.connector.catalog.NamespaceChange.RemoveProperty
import com.pubmatic.spark.sql.connector.expressions.{BucketTransform, FieldReference, IdentityTransform, Transform}
