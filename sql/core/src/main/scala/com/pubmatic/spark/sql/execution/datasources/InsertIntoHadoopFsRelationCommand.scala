...
import com.pubmatic.spark.sql.catalyst.catalog.{BucketSpec, CatalogTable, CatalogTablePartition}
...
case class InsertIntoHadoopFsRelationCommand(
  ...
  import com.pubmatic.spark.sql.catalyst.catalog.ExternalCatalogUtils.escapePathName
