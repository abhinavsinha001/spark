...
import com.pubmatic.spark.sql.catalyst.{CatalystTypeConverters, InternalRow}
import com.pubmatic.spark.sql.catalyst.expressions.{AttributeReference, Expression, _}
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.ImperativeAggregate
import com.pubmatic.spark.sql.catalyst.expressions.codegen.GenerateMutableProjection
import com.pubmatic.spark.sql.expressions.{MutableAggregationBuffer, UserDefinedAggregateFunction}
import com.pubmatic.spark.sql.types._

/**
 * A helper trait used to create specialized setter and getter for types supported by
 * [[com.pubmatic.spark.sql.execution.UnsafeFixedWidthAggregationMap]]'s buffer.
