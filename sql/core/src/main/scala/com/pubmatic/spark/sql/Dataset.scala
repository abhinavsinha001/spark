...
import com.pubmatic.spark.{SparkException, TaskContext}
import com.pubmatic.spark.api.java.JavaRDD
import com.pubmatic.spark.api.java.function._
import com.pubmatic.spark.api.python.{PythonRDD, SerDeUtil}
import com.pubmatic.spark.api.r.RRDD
import com.pubmatic.spark.broadcast.Broadcast
import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.sql.catalyst.QueryPlanningTracker
import com.pubmatic.spark.sql.catalyst.analysis._
import com.pubmatic.spark.sql.catalyst.catalog.HiveTableRelation
import com.pubmatic.spark.sql.catalyst.encoders._
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.json.{JSONOptions, JacksonGenerator}
import com.pubmatic.spark.sql.catalyst.optimizer.CombineUnions
import com.pubmatic.spark.sql.catalyst.parser.{ParseException, ParserUtils}
import com.pubmatic.spark.sql.catalyst.plans._
import com.pubmatic.spark.sql.catalyst.plans.logical._
import com.pubmatic.spark.sql.catalyst.plans.physical.{Partitioning, PartitioningCollection}
import com.pubmatic.spark.sql.catalyst.trees.TreeNodeTag
import com.pubmatic.spark.sql.catalyst.util.IntervalUtils
import com.pubmatic.spark.sql.execution._
import com.pubmatic.spark.sql.execution.arrow.{ArrowBatchStreamWriter, ArrowConverters}
import com.pubmatic.spark.sql.execution.command._
import com.pubmatic.spark.sql.execution.datasources.LogicalRelation
import com.pubmatic.spark.sql.execution.datasources.v2.{DataSourceV2ScanRelation, FileTable}
import com.pubmatic.spark.sql.execution.python.EvaluatePython
import com.pubmatic.spark.sql.execution.stat.StatFunctions
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.streaming.DataStreamWriter
...
class Dataset[T] private[sql](
  ...
  * [[com.pubmatic.spark.sql.streaming.StreamingQueryListener]] or a
  * [[com.pubmatic.spark.sql.util.QueryExecutionListener]] to the spark session.
  *
  * {{{
