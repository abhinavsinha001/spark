...
import com.pubmatic.spark.sql.catalyst.analysis.{Resolver, TypeCoercion}
import com.pubmatic.spark.sql.catalyst.catalog.CatalogTypes.TablePartitionSpec
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, AttributeReference, Cast, Literal}
import com.pubmatic.spark.sql.catalyst.util.{CaseInsensitiveMap, DateFormatter, DateTimeUtils, TimestampFormatter}
...
object PartitioningUtils {
  ...
  import com.pubmatic.spark.sql.catalyst.catalog.ExternalCatalogUtils.{escapePathName, unescapePathName, DEFAULT_PARTITION_NAME}
  ...
  private[datasources] def inferPartitionColumnValue(
    ...
    val dateTry = Try {
      ...
      // com.pubmatic.spark.sql.execution.datasources.PartitioningAwareFileIndex.inferPartitioning)
