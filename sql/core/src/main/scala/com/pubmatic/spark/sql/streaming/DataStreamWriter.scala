...
import com.pubmatic.spark.sql.connector.catalog.{SupportsWrite, TableProvider}
...
import com.pubmatic.spark.sql.execution.datasources.v2.DataSourceV2Utils
import com.pubmatic.spark.sql.execution.streaming._
import com.pubmatic.spark.sql.execution.streaming.sources._
...
final class DataStreamWriter[T] private[sql](ds: Dataset[T]) {
   ...
   * object. See [[com.pubmatic.spark.sql.ForeachWriter]] for more details on the lifecycle and
   * semantics.
 *
   * @since 2.0.0
   */
