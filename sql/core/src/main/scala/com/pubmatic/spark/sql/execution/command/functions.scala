...
import com.pubmatic.spark.sql.catalyst.analysis.{FunctionRegistry, NoSuchFunctionException}
import com.pubmatic.spark.sql.catalyst.catalog.{CatalogFunction, FunctionResource}
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, ExpressionInfo}
