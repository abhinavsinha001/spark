...
package com.pubmatic.spark.sql.execution.datasources
...
import com.pubmatic.spark.sql._
import com.pubmatic.spark.sql.catalyst.analysis.UnresolvedAttribute
import com.pubmatic.spark.sql.catalyst.catalog.{BucketSpec, CatalogStorageFormat, CatalogTable, CatalogUtils}
import com.pubmatic.spark.sql.catalyst.plans.logical.LogicalPlan
import com.pubmatic.spark.sql.catalyst.util.CaseInsensitiveMap
import com.pubmatic.spark.sql.connector.catalog.TableProvider
import com.pubmatic.spark.sql.execution.SparkPlan
import com.pubmatic.spark.sql.execution.command.DataWritingCommand
import com.pubmatic.spark.sql.execution.datasources.csv.CSVFileFormat
import com.pubmatic.spark.sql.execution.datasources.jdbc.JdbcRelationProvider
import com.pubmatic.spark.sql.execution.datasources.json.JsonFileFormat
import com.pubmatic.spark.sql.execution.datasources.orc.OrcFileFormat
import com.pubmatic.spark.sql.execution.datasources.parquet.ParquetFileFormat
import com.pubmatic.spark.sql.execution.datasources.v2.FileDataSourceV2
import com.pubmatic.spark.sql.execution.datasources.v2.orc.OrcDataSourceV2
import com.pubmatic.spark.sql.execution.streaming._
import com.pubmatic.spark.sql.execution.streaming.sources.{RateStreamProvider, TextSocketSourceProvider}
...
import com.pubmatic.spark.sql.types.{CalendarIntervalType, StructField, StructType}
import com.pubmatic.spark.sql.util.SchemaUtils
 ...
 * [[com.pubmatic.spark.sql.DataFrameReader]] or CREATE TABLE USING DDL.  Additionally, this class is
...
object DataSource extends Logging {
  ...
  private val backwardCompatibilityMap: Map[String, String] = {
    ...
    val orc = "com.pubmatic.spark.sql.hive.orc.OrcFileFormat"
    ...
    Map(
      "com.pubmatic.spark.sql.jdbc" -> jdbc,
      "com.pubmatic.spark.sql.jdbc.DefaultSource" -> jdbc,
      "com.pubmatic.spark.sql.execution.datasources.jdbc.DefaultSource" -> jdbc,
      "com.pubmatic.spark.sql.execution.datasources.jdbc" -> jdbc,
      "com.pubmatic.spark.sql.json" -> json,
      "com.pubmatic.spark.sql.json.DefaultSource" -> json,
      "com.pubmatic.spark.sql.execution.datasources.json" -> json,
      "com.pubmatic.spark.sql.execution.datasources.json.DefaultSource" -> json,
      "com.pubmatic.spark.sql.parquet" -> parquet,
      "com.pubmatic.spark.sql.parquet.DefaultSource" -> parquet,
      "com.pubmatic.spark.sql.execution.datasources.parquet" -> parquet,
      "com.pubmatic.spark.sql.execution.datasources.parquet.DefaultSource" -> parquet,
      "com.pubmatic.spark.sql.hive.orc.DefaultSource" -> orc,
      "com.pubmatic.spark.sql.hive.orc" -> orc,
      "com.pubmatic.spark.sql.execution.datasources.orc.DefaultSource" -> nativeOrc,
      "com.pubmatic.spark.sql.execution.datasources.orc" -> nativeOrc,
      "org.apache.spark.ml.source.libsvm.DefaultSource" -> libsvm,
      "org.apache.spark.ml.source.libsvm" -> libsvm,
      "com.databricks.spark.csv" -> csv,
      "com.pubmatic.spark.sql.execution.streaming.TextSocketSourceProvider" -> socket,
      "com.pubmatic.spark.sql.execution.streaming.RateSourceProvider" -> rate
    )
  }
  ...
  private val spark2RemovedClasses = Set(
    "com.pubmatic.spark.sql.DataFrame",
    "com.pubmatic.spark.sql.sources.HadoopFsRelationProvider",
  ...
  def lookupDataSource(provider: String, conf: SQLConf): Class[_] = {
    val provider1 = backwardCompatibilityMap.getOrElse(provider, provider) match {
      ...
      case name if name.equalsIgnoreCase("orc") &&
        ...
        "com.pubmatic.spark.sql.hive.orc.OrcFileFormat"
      case "com.databricks.spark.avro" if conf.replaceDatabricksSparkAvroEnabled =>
        "com.pubmatic.spark.sql.avro.AvroFileFormat"
      case name => name
    }
          ...
          try {
            Try(loader.loadClass(provider1)).orElse(Try(loader.loadClass(provider2))) match {
              case Success(dataSource) =>
                ...
                dataSource
              case Failure(error) =>
                if (provider1.startsWith("com.pubmatic.spark.sql.hive.orc")) {
                  throw new AnalysisException(
                  ...
                  provider1 == "com.pubmatic.spark.sql.avro") {
                  throw new AnalysisException(
