...
import com.pubmatic.spark.{SparkConf, SparkContext, SparkException}
import com.pubmatic.spark.internal.Logging

import com.pubmatic.spark.sql.catalyst.catalog._
import com.pubmatic.spark.sql.execution.CacheManager
import com.pubmatic.spark.sql.execution.streaming.StreamExecution
import com.pubmatic.spark.sql.execution.ui.{SQLAppStatusListener, SQLAppStatusStore, SQLTab}
...
private[sql] class SharedState(
  ...
  val jarClassLoader = new NonClosableMutableURLClassLoader(
    com.pubmatic.spark.util.Utils.getContextOrSparkClassLoader)
...
object SharedState extends Logging {
  ...
  private val HIVE_EXTERNAL_CATALOG_CLASS_NAME = "com.pubmatic.spark.sql.hive.HiveExternalCatalog"
