...
import com.pubmatic.spark.sql.catalyst.streaming.InternalOutputModes._
import com.pubmatic.spark.sql.connector.catalog.{SupportsWrite, Table}
import com.pubmatic.spark.sql.connector.read.streaming.{Offset => OffsetV2, SparkDataStream}
import com.pubmatic.spark.sql.connector.write.SupportsTruncate
...
import com.pubmatic.spark.sql.execution.command.StreamingExplainCommand
import com.pubmatic.spark.sql.execution.datasources.v2.StreamWriterCommitProgress
...
import com.pubmatic.spark.util.{Clock, UninterruptibleThread, Utils}
...
abstract class StreamExecution(
   ...
   * [[com.pubmatic.spark.util.UninterruptibleThread]] to workaround KAFKA-1894: interrupting a
