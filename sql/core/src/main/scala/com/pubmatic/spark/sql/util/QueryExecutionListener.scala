...
import com.pubmatic.spark.sql.execution.ui.SparkListenerSQLExecutionEnd
import com.pubmatic.spark.sql.internal.StaticSQLConf._
import com.pubmatic.spark.util.{ListenerBus, Utils}
...
/**
 * Manager for [[QueryExecutionListener]]. See `com.pubmatic.spark.sql.SQLContext.listenerManager`.
 */
