 ...
 * less verbose invocation.  For example, 'com.pubmatic.spark.sql.json' would resolve to the
 * data source 'com.pubmatic.spark.sql.json.DefaultSource'
 *
 * A new instance of this class will be instantiated each time a DDL call is made.
 *
 * @since 1.3.0
 ...
 * `com.pubmatic.spark.sql.catalyst.plans.logical.LogicalPlan`.  Unlike the other APIs this
