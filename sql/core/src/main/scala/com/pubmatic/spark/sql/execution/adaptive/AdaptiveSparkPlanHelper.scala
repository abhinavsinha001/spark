 ...
 * plan. Unlike their counterparts in [[com.pubmatic.spark.sql.catalyst.trees.TreeNode]] or
 * [[com.pubmatic.spark.sql.catalyst.plans.QueryPlan]], these methods traverse down leaf nodes of
