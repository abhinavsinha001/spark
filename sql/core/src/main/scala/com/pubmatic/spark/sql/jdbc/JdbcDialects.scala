...
abstract class JdbcDialect extends Serializable {
   ...
   * @return The actual DataType (subclasses of [[com.pubmatic.spark.sql.types.DataType]])
...
/**
 * :: DeveloperApi ::
 * Registry of dialects that apply to every new jdbc `com.pubmatic.spark.sql.DataFrame`.
 *
...
object JdbcDialects {
  ...
  /**
   * Register a dialect for use on all new matching jdbc `com.pubmatic.spark.sql.DataFrame`.
