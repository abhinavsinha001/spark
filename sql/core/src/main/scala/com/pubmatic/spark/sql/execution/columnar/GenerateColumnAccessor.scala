...
import com.pubmatic.spark.sql.catalyst.expressions.codegen.{CodeAndComment, CodeFormatter, CodeGenerator, UnsafeRowWriter}
...
object GenerateColumnAccessor extends CodeGenerator[Seq[DataType], ColumnarIterator] with Logging {
  ...
  protected def create(columnTypes: Seq[DataType]): ColumnarIterator = {
    ...
    val codeBody = s"""
      ...
      import com.pubmatic.spark.sql.catalyst.expressions.codegen.BufferHolder;
      import com.pubmatic.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter;
      import com.pubmatic.spark.sql.execution.columnar.MutableUnsafeRow;
