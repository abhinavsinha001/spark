...
import com.pubmatic.spark.{SparkConf, SparkContext, TaskContext}
...
import com.pubmatic.spark.scheduler.{SparkListener, SparkListenerApplicationEnd}

import com.pubmatic.spark.sql.catalog.Catalog
import com.pubmatic.spark.sql.catalyst._
import com.pubmatic.spark.sql.catalyst.analysis.UnresolvedRelation
import com.pubmatic.spark.sql.catalyst.encoders._
import com.pubmatic.spark.sql.catalyst.expressions.AttributeReference
import com.pubmatic.spark.sql.catalyst.plans.logical.{LocalRelation, Range}
import com.pubmatic.spark.sql.execution._
import com.pubmatic.spark.sql.execution.datasources.LogicalRelation
import com.pubmatic.spark.sql.internal._
...
import com.pubmatic.spark.sql.types.{DataType, StructType}
import com.pubmatic.spark.sql.util.ExecutionListenerManager
import com.pubmatic.spark.util.{CallSite, Utils}
...
class SparkSession private(
   ...
   * @since 2.0.0
   */
  def version: String = com.pubmatic.spark.SPARK_VERSION
   ...
   * functions, and everything else that accepts a [[com.pubmatic.spark.sql.internal.SQLConf]].
  ...
  /**
   * An interface to register custom [[com.pubmatic.spark.sql.util.QueryExecutionListener]]s
   ...
   *  val sparkSession = new com.pubmatic.spark.sql.SparkSession(sc)
   *
   *  val schema =
   *    StructType(
...
object SparkSession extends Logging {
  ...
  private val HIVE_SESSION_STATE_BUILDER_CLASS_NAME =
    "com.pubmatic.spark.sql.hive.HiveSessionStateBuilder"
