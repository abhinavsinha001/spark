...
import com.pubmatic.spark.sql.execution.stat._
import com.pubmatic.spark.sql.functions.col
import com.pubmatic.spark.sql.types._
import com.pubmatic.spark.util.sketch.{BloomFilter, CountMinSketch}
...
final class DataFrameStatFunctions private[sql](df: DataFrame) {
   ...
   *    import com.pubmatic.spark.sql.functions.struct
   *
  ...
  def sampleBy[T](col: Column, fractions: Map[T, Double], seed: Long): DataFrame = {
    ...
    import com.pubmatic.spark.sql.functions.{rand, udf}
    val r = rand(seed)
