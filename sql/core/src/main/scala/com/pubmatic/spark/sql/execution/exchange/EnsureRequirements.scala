...
import com.pubmatic.spark.sql.execution.joins.{ShuffledHashJoinExec, SortMergeJoinExec}
import com.pubmatic.spark.sql.internal.SQLConf

/**
 * Ensures that the [[com.pubmatic.spark.sql.catalyst.plans.physical.Partitioning Partitioning]]
 * of input data meets the
 * [[com.pubmatic.spark.sql.catalyst.plans.physical.Distribution Distribution]] requirements for
