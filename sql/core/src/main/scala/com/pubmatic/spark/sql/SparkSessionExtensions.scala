...
import com.pubmatic.spark.sql.execution.ColumnarRule
...
class SparkSessionExtensions {
   ...
   * [[com.pubmatic.spark.sql.execution.SparkPlan]].
   */
  ...
  /**
  * Injects a custom function into the [[com.pubmatic.spark.sql.catalyst.analysis.FunctionRegistry]]
