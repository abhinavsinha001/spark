...
import com.pubmatic.spark.sql.execution.vectorized.{MutableColumnarRow, OnHeapColumnVector}
...
class VectorizedHashMapGenerator(
   ...
   * associated [[com.pubmatic.spark.sql.execution.vectorized.OnHeapColumnVector]]. For instance,
   ...
   * [[com.pubmatic.spark.sql.execution.vectorized.MutableColumnarRow]] which keeps track of the
   ...
   * [[com.pubmatic.spark.sql.execution.vectorized.OnHeapColumnVector]]. For instance, if we
