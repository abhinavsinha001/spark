...
import com.pubmatic.spark.sql.catalyst.plans.logical.{Filter, LeafNode, LogicalPlan, Project}
...
import com.pubmatic.spark.sql.execution.datasources.v2.orc.OrcTable
import com.pubmatic.spark.sql.execution.datasources.v2.parquet.ParquetTable
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.types.{ArrayType, DataType, MapType, StructField, StructType}
...
object SchemaPruning extends Rule[LogicalPlan] {
  import com.pubmatic.spark.sql.catalyst.expressions.SchemaPruning._
