...
package com.pubmatic.spark.sql.execution.datasources.jdbc
...
import com.pubmatic.spark.sql.{AnalysisException, DataFrame, Row}
...
import com.pubmatic.spark.sql.catalyst.expressions.SpecificInternalRow
import com.pubmatic.spark.sql.catalyst.parser.CatalystSqlParser
import com.pubmatic.spark.sql.catalyst.util.{CaseInsensitiveMap, DateTimeUtils, GenericArrayData}
import com.pubmatic.spark.sql.jdbc.{JdbcDialect, JdbcDialects, JdbcType}
import com.pubmatic.spark.sql.types._
import com.pubmatic.spark.sql.util.SchemaUtils
import org.apache.spark.unsafe.types.UTF8String
import com.pubmatic.spark.util.NextIterator
...
object JdbcUtils extends Logging {
   ...
   *
   * @param dt The datatype (e.g. [[com.pubmatic.spark.sql.types.StringType]])
