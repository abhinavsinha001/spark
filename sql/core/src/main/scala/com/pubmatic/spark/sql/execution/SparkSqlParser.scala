...
import com.pubmatic.spark.sql.catalyst.parser._
...
import com.pubmatic.spark.sql.internal.{HiveSerDe, SQLConf, VariableSubstitution}
...
class SparkSqlAstBuilder(conf: SQLConf) extends AstBuilder(conf) {
  import com.pubmatic.spark.sql.catalyst.parser.ParserUtils._
