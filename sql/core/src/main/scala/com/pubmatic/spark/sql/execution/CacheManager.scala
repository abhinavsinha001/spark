...
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, SubqueryExpression}
import com.pubmatic.spark.sql.catalyst.optimizer.EliminateResolvedHint
import com.pubmatic.spark.sql.catalyst.plans.logical.{IgnoreCachedData, LogicalPlan, ResolvedHint}
import com.pubmatic.spark.sql.execution.columnar.InMemoryRelation
import com.pubmatic.spark.sql.execution.command.CommandUtils
import com.pubmatic.spark.sql.execution.datasources.{FileIndex, HadoopFsRelation, LogicalRelation}
import com.pubmatic.spark.sql.execution.datasources.v2.{DataSourceV2Relation, FileTable}
import com.pubmatic.spark.storage.StorageLevel
import com.pubmatic.spark.storage.StorageLevel.MEMORY_AND_DISK
...
class CacheManager extends Logging {
   ...
   * [[com.pubmatic.spark.sql.execution.datasources.FileIndex]] of any [[HadoopFsRelation]] nodes
