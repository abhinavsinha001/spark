...
import com.pubmatic.spark.sql.execution.streaming.CheckpointFileManager.RenameHelperMethods
 ...
 * [[com.pubmatic.spark.sql.execution.streaming.state.StateStore StateStore]] implementations
...
trait CheckpointFileManager {
  ...
  import com.pubmatic.spark.sql.execution.streaming.CheckpointFileManager._
