...
package com.pubmatic.spark.sql.execution

import com.pubmatic.spark.rdd.RDD
import com.pubmatic.spark.sql.{execution, AnalysisException, Strategy}
import com.pubmatic.spark.sql.catalyst.InternalRow
import com.pubmatic.spark.sql.catalyst.encoders.RowEncoder
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.AggregateExpression
import com.pubmatic.spark.sql.catalyst.optimizer.NormalizeFloatingNumbers
import com.pubmatic.spark.sql.catalyst.planning._
...
import com.pubmatic.spark.sql.catalyst.streaming.InternalOutputModes
import com.pubmatic.spark.sql.execution.adaptive.LogicalQueryStage
import com.pubmatic.spark.sql.execution.columnar.{InMemoryRelation, InMemoryTableScanExec}
import com.pubmatic.spark.sql.execution.command._
import com.pubmatic.spark.sql.execution.exchange.ShuffleExchangeExec
import com.pubmatic.spark.sql.execution.joins.{BuildLeft, BuildRight, BuildSide}
import com.pubmatic.spark.sql.execution.python._
import com.pubmatic.spark.sql.execution.streaming._
import com.pubmatic.spark.sql.execution.streaming.sources.MemoryPlan
import com.pubmatic.spark.sql.internal.SQLConf
import com.pubmatic.spark.sql.streaming.{OutputMode, StreamingQuery}
 ...
 * [[com.pubmatic.spark.sql.sources]]
 */
...
abstract class SparkStrategies extends QueryPlanner[SparkPlan] {
   ...
   * on-demand, only when planning in a [[com.pubmatic.spark.sql.execution.streaming.StreamExecution]]
   */
