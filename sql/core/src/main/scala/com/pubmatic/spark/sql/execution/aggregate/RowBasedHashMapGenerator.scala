...
package com.pubmatic.spark.sql.execution.aggregate
...
import com.pubmatic.spark.sql.catalyst.expressions.codegen.{CodegenContext, CodeGenerator}
...
class RowBasedHashMapGenerator(
  ...
  override protected def initializeAggregateHashMap(): String = {
    ...
    s"""
       |  private com.pubmatic.spark.sql.catalyst.expressions.RowBasedKeyValueBatch batch;
       |  private int[] buckets;
       ...
       |  private com.pubmatic.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter agg_rowWriter;
       |
       |
       |  public $generatedClassName(
       |    TaskMemoryManager taskMemoryManager,
       |    InternalRow emptyAggregationBuffer) {
       |    batch = com.pubmatic.spark.sql.catalyst.expressions.RowBasedKeyValueBatch
       ...
       |
       |    agg_rowWriter = new com.pubmatic.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(
   ...
   * associated [[com.pubmatic.spark.sql.catalyst.expressions.RowBasedKeyValueBatch]].
   *
   */
   ...
   * [[com.pubmatic.spark.sql.catalyst.expressions.UnsafeRow]] which keeps track of the
   ...
   * [[com.pubmatic.spark.sql.catalyst.expressions.RowBasedKeyValueBatch]].
   *
   */
   protected def generateFindOrInsert(): String = {
    ...
    s"""
       |public com.pubmatic.spark.sql.catalyst.expressions.UnsafeRow findOrInsert(${
       ...
       |        com.pubmatic.spark.sql.catalyst.expressions.UnsafeRow agg_result
