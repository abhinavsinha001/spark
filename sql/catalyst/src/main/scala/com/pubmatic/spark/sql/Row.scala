...
import com.pubmatic.spark.sql.catalyst.CatalystTypeConverters
...
import com.pubmatic.spark.sql.types.{ArrayType, BinaryType, DataType, Decimal, MapType, StringType, StructType, UserDefinedType}
...
trait Row extends Serializable {
   ...
   * [[com.pubmatic.spark.sql.catalyst.encoders.RowEncoder]].
   *
