...
package com.pubmatic.spark.sql.types
...
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, AttributeReference, InterpretedOrdering}
import com.pubmatic.spark.sql.catalyst.parser.{CatalystSqlParser, LegacyTypeStringParser}
import com.pubmatic.spark.sql.catalyst.util.{quoteIdentifier, truncatedString}
 ...
 * }}}
 *
 * A [[com.pubmatic.spark.sql.Row]] object is used as a value of the [[StructType]].
 *
 * Scala Example:
 * {{{
 * import com.pubmatic.spark.sql._
