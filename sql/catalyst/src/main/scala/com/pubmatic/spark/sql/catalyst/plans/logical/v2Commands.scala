...
import com.pubmatic.spark.sql.catalyst.analysis.{NamedRelation, Star, UnresolvedException}
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, AttributeReference, Expression, Unevaluable}
import com.pubmatic.spark.sql.catalyst.plans.DescribeTableSchema
import com.pubmatic.spark.sql.connector.catalog.{CatalogManager, CatalogPlugin, Identifier, SupportsNamespaces, TableCatalog, TableChange}
...
import com.pubmatic.spark.sql.types.{DataType, MetadataBuilder, StringType, StructType}
