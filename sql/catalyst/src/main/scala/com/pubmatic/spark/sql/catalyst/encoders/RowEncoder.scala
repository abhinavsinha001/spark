...
import com.pubmatic.spark.sql.catalyst.{ScalaReflection, WalkedTypePath}
import com.pubmatic.spark.sql.catalyst.DeserializerBuildHelper._
import com.pubmatic.spark.sql.catalyst.SerializerBuildHelper._
import com.pubmatic.spark.sql.catalyst.analysis.GetColumnByOrdinal
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.expressions.objects._
import com.pubmatic.spark.sql.catalyst.util.{ArrayBasedMapData, ArrayData}
 ...
 *   StructType -> com.pubmatic.spark.sql.Row
 * }}}
 */
object RowEncoder {
   ...
   * `com.pubmatic.spark.sql.types.Decimal`.
   */
