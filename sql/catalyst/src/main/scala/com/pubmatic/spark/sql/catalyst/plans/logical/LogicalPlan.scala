...
import com.pubmatic.spark.sql.catalyst.plans.logical.statsEstimation.LogicalPlanStats
...
abstract class LogicalPlan
   ...
   * [[com.pubmatic.spark.sql.catalyst.analysis.UnresolvedRelation UnresolvedRelation]]
   * should return `false`).
   */
