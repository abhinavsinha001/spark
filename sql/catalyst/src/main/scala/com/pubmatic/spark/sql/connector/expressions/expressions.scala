...
package com.pubmatic.spark.sql.connector.expressions

import com.pubmatic.spark.sql.catalyst
...
private[sql] final case class FieldReference(parts: Seq[String]) extends NamedReference {
  import com.pubmatic.spark.sql.connector.catalog.CatalogV2Implicits.MultipartIdentifierHelper
