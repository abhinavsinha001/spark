...
import com.pubmatic.spark.sql.catalyst.analysis.{NamedRelation, NoSuchDatabaseException, NoSuchNamespaceException, NoSuchTableException, UnresolvedV2Relation}
import com.pubmatic.spark.sql.catalyst.plans.logical.AlterTable
import com.pubmatic.spark.sql.connector.catalog.TableChange._
import com.pubmatic.spark.sql.execution.datasources.v2.DataSourceV2Relation
import com.pubmatic.spark.sql.types.{ArrayType, MapType, StructField, StructType}
