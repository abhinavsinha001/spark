 ...
 */
package com.pubmatic.spark.sql.catalyst.expressions.postgreSQL

import com.pubmatic.spark.sql.catalyst.analysis.TypeCheckResult
import com.pubmatic.spark.sql.catalyst.expressions.{CastBase, Expression, TimeZoneAwareExpression}
import com.pubmatic.spark.sql.catalyst.expressions.codegen.Block._
import com.pubmatic.spark.sql.catalyst.util.postgreSQL.StringUtils
