...
import com.pubmatic.spark.sql.catalyst.analysis.{TypeCheckResult, UnresolvedException}
...
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.{AggregateFunction, DeclarativeAggregate, NoOp}
