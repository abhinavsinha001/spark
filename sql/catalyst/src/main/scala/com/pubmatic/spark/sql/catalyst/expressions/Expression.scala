...
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.DeclarativeAggregate
...
abstract class Expression extends TreeNode[Expression] {
   ...
   * executed. A typical use case: [[com.pubmatic.spark.sql.catalyst.optimizer.ConstantFolding]]
   *
