...
import com.pubmatic.spark.sql.catalyst.{FunctionIdentifier, InternalRow, TableIdentifier}
import com.pubmatic.spark.sql.catalyst.errors.TreeNodeException
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.expressions.codegen.{CodegenContext, ExprCode}
import com.pubmatic.spark.sql.catalyst.parser.ParserUtils
import com.pubmatic.spark.sql.catalyst.plans.logical.{LeafNode, LogicalPlan, UnaryNode}
import com.pubmatic.spark.sql.catalyst.trees.TreeNode
import com.pubmatic.spark.sql.catalyst.util.quoteIdentifier
import com.pubmatic.spark.sql.connector.catalog.{Identifier, TableCatalog}
import com.pubmatic.spark.sql.types.{DataType, Metadata, StructType}
 ...
 * a [[com.pubmatic.spark.sql.catalyst.plans.logical.LocalRelation]].
 *
 ...
 * the [[com.pubmatic.spark.sql.catalyst.plans.logical.Generate]] operator.
