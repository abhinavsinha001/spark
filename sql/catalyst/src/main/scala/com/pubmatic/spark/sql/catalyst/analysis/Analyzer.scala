...
import com.pubmatic.spark.sql.catalyst.expressions.SubExprUtils._
import com.pubmatic.spark.sql.catalyst.expressions.aggregate._
import com.pubmatic.spark.sql.catalyst.expressions.objects._
...
import com.pubmatic.spark.sql.catalyst.trees.TreeNodeRef
import com.pubmatic.spark.sql.catalyst.util.toPrettySQL
import com.pubmatic.spark.sql.connector.catalog.{CatalogManager, CatalogPlugin, CatalogV2Util, Identifier, LookupCatalog, Table, TableCatalog, TableChange, V1Table}
import com.pubmatic.spark.sql.connector.expressions.{FieldReference, IdentityTransform, Transform}
...
import com.pubmatic.spark.sql.internal.SQLConf.{PartitionOverwriteMode, StoreAssignmentPolicy}
...
object TimeWindowing extends Rule[LogicalPlan] {
  import com.pubmatic.spark.sql.catalyst.dsl.expressions._
