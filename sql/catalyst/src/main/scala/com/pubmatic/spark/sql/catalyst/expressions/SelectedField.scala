...
/**
 * A Scala extractor that builds a [[com.pubmatic.spark.sql.types.StructField]] from a Catalyst
 ...
 * }}}
 *
 * by mapping each complex type extractor to a [[com.pubmatic.spark.sql.types.StructField]] with the
 ...
 * is "name" and its data type is a [[com.pubmatic.spark.sql.types.StructType]] with a single string
 * field named "first".
 */
