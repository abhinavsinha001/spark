...
import com.pubmatic.spark.sql.catalyst.optimizer.BooleanSimplification
import com.pubmatic.spark.sql.catalyst.plans._
import com.pubmatic.spark.sql.catalyst.plans.logical._
import com.pubmatic.spark.sql.connector.catalog.TableChange.{AddColumn, DeleteColumn, RenameColumn, UpdateColumnComment, UpdateColumnType}
