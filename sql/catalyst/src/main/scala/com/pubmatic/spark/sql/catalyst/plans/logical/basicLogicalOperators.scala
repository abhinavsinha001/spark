...
package com.pubmatic.spark.sql.catalyst.plans.logical

import com.pubmatic.spark.sql.catalyst.AliasIdentifier
import com.pubmatic.spark.sql.catalyst.analysis.{MultiInstanceRelation, NamedRelation}
import com.pubmatic.spark.sql.catalyst.catalog.{CatalogStorageFormat, CatalogTable}
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.{AggregateExpression, AggregateFunction}
import com.pubmatic.spark.sql.catalyst.plans._
import com.pubmatic.spark.sql.catalyst.plans.physical.{HashPartitioning, Partitioning, RangePartitioning, RoundRobinPartitioning}
import com.pubmatic.spark.sql.catalyst.util.truncatedString
import com.pubmatic.spark.sql.connector.catalog.{CatalogManager, Identifier, SupportsNamespaces, TableCatalog, TableChange}
import com.pubmatic.spark.sql.connector.catalog.TableChange.{AddColumn, ColumnChange}
import com.pubmatic.spark.sql.connector.expressions.Transform
import com.pubmatic.spark.sql.types._
import com.pubmatic.spark.util.random.RandomSampler
 ...
 * For example, see the rule [[com.pubmatic.spark.sql.catalyst.optimizer.SimplifyExtractValueOps]]
 */
...
case class OneRowRelation() extends LeafNode {
  ...
  /** [[com.pubmatic.spark.sql.catalyst.trees.TreeNode.makeCopy()]] does not support 0-arg ctor. */
