...
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, AttributeMap, AttributeReference, Cast, ExprId, Literal}
 ...
 * @param className fully qualified class name, e.g. "com.pubmatic.spark.util.MyFunc"
