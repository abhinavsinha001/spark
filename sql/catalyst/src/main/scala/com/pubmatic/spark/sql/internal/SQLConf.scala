...
import com.pubmatic.spark.{SparkContext, TaskContext}
import com.pubmatic.spark.internal.Logging
import com.pubmatic.spark.internal.config._
import org.apache.spark.network.util.ByteUnit
import com.pubmatic.spark.sql.catalyst.analysis.{HintErrorLogger, Resolver}
import com.pubmatic.spark.sql.catalyst.expressions.CodegenObjectFactoryMode
import com.pubmatic.spark.sql.catalyst.expressions.codegen.CodeGenerator
import com.pubmatic.spark.sql.catalyst.plans.logical.HintErrorHandler
import com.pubmatic.spark.sql.connector.catalog.CatalogManager.SESSION_CATALOG_NAME
...
object SQLConf {
  ...
  val FILE_COMMIT_PROTOCOL_CLASS =
    buildConf("spark.sql.sources.commitProtocolClass")
      ...
      .stringConf
      .createWithDefault(
        "com.pubmatic.spark.sql.execution.datasources.SQLHadoopMapReduceCommitProtocol")
  ...
  val STREAMING_FILE_COMMIT_PROTOCOL_CLASS =
    buildConf("spark.sql.streaming.commitProtocolClass")
      .internal()
      .stringConf
      .createWithDefault("com.pubmatic.spark.sql.execution.streaming.ManifestFileCommitProtocol")
  ...
  val SQL_STRING_REDACTION_PATTERN =
    buildConf("spark.sql.redaction.string.regex")
      ...
      .fallbackConf(com.pubmatic.spark.internal.config.STRING_REDACTION_PATTERN)
...
class SQLConf extends Serializable with Logging {
  ...
  def resolver: Resolver = {
    if (caseSensitiveAnalysis) {
      com.pubmatic.spark.sql.catalyst.analysis.caseSensitiveResolution
    } else {
      com.pubmatic.spark.sql.catalyst.analysis.caseInsensitiveResolution
    }
  }
