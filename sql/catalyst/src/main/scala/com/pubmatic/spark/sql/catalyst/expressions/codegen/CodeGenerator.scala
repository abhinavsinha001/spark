...
package com.pubmatic.spark.sql.catalyst.expressions.codegen
...
import com.pubmatic.spark.executor.InputMetrics
import com.pubmatic.spark.internal.Logging
import com.pubmatic.spark.metrics.source.CodegenMetrics
...
import com.pubmatic.spark.sql.catalyst.util.{ArrayData, GenericArrayData, MapData}
...
import com.pubmatic.spark.{TaskContext, TaskKilledException}
import com.pubmatic.spark.util.{ParentClassLoader, Utils}
...
class CodegenContext extends Logging {
  ...
  def genComp(dataType: DataType, c1: String, c2: String): String = dataType match {
    ...
    case DoubleType => s"com.pubmatic.spark.util.Utils.nanSafeCompareDoubles($c1, $c2)"
    case FloatType => s"com.pubmatic.spark.util.Utils.nanSafeCompareFloats($c1, $c2)"
    // use c1 - c2 may overflow
    case dt: DataType if isPrimitiveType(dt) => s"($c1 > $c2 ? 1 : $c1 < $c2 ? -1 : 0)"
    case BinaryType => s"com.pubmatic.spark.sql.catalyst.util.TypeUtils.compareBinary($c1, $c2)"
...
object CodeGenerator extends Logging {
  ...
  private[this] def doCompile(code: CodeAndComment): (GeneratedClass, ByteCodeStats) = {
    ...
    evaluator.setClassName("com.pubmatic.spark.sql.catalyst.expressions.GeneratedClass")
