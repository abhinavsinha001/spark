...
package com.pubmatic.spark.sql.connector.read;
 ...
 *
 * Note that, Currently the type `T` can only be {@link com.pubmatic.spark.sql.catalyst.InternalRow}
 * for normal data sources, or {@link com.pubmatic.spark.sql.vectorized.ColumnarBatch} for columnar
