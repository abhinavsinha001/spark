...
import static com.pubmatic.spark.sql.catalyst.expressions.UnsafeArrayData.calculateHeaderPortionInBytes;

/**
 * A helper class to write data into global row buffer using `UnsafeArrayData` format,
 * used by {@link com.pubmatic.spark.sql.catalyst.expressions.codegen.GenerateUnsafeProjection}.
 */
