...
import com.pubmatic.spark.sql.catalyst.{AliasIdentifier, FunctionIdentifier, InternalRow, TableIdentifier}
import com.pubmatic.spark.sql.catalyst.catalog._
import com.pubmatic.spark.sql.catalyst.dsl.expressions.DslString
import com.pubmatic.spark.sql.catalyst.expressions._
import com.pubmatic.spark.sql.catalyst.expressions.codegen.CodegenFallback
import com.pubmatic.spark.sql.catalyst.plans.{LeftOuter, NaturalJoin, SQLHelper}
import com.pubmatic.spark.sql.catalyst.plans.logical._
import com.pubmatic.spark.sql.catalyst.plans.physical.{IdentityBroadcastMode, RoundRobinPartitioning, SinglePartition}
...
case class ComplexPlan(exprs: Seq[Seq[Expression]])
  extends com.pubmatic.spark.sql.catalyst.plans.logical.LeafNode {
