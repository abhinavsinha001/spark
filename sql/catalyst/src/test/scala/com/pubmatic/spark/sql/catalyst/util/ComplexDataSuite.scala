...
import com.pubmatic.spark.sql.catalyst.expressions.{BoundReference, GenericInternalRow, SpecificInternalRow, UnsafeMapData, UnsafeProjection}
import com.pubmatic.spark.sql.catalyst.expressions.codegen.GenerateUnsafeProjection
import com.pubmatic.spark.sql.types.{DataType, IntegerType, MapType, StringType}
