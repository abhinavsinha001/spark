...
import com.pubmatic.spark.sql.catalyst.analysis.EliminateSubqueryAliases
...
import com.pubmatic.spark.sql.catalyst.planning.ExtractFiltersAndInnerJoins
import com.pubmatic.spark.sql.catalyst.plans.{Cross, Inner, InnerLike, PlanTest}
