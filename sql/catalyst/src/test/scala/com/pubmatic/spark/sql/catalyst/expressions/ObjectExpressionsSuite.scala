...
import com.pubmatic.spark.sql.{RandomDataGenerator, Row}
import com.pubmatic.spark.sql.catalyst.{CatalystTypeConverters, InternalRow, JavaTypeInference, ScalaReflection}
import com.pubmatic.spark.sql.catalyst.ScroogeLikeExample
import com.pubmatic.spark.sql.catalyst.analysis.{ResolveTimeZone, SimpleAnalyzer, UnresolvedDeserializer}
import com.pubmatic.spark.sql.catalyst.dsl.expressions._
import com.pubmatic.spark.sql.catalyst.encoders._
import com.pubmatic.spark.sql.catalyst.expressions.codegen.GenerateUnsafeProjection
import com.pubmatic.spark.sql.catalyst.expressions.objects._
import com.pubmatic.spark.sql.catalyst.plans.logical.{LocalRelation, Project}
import com.pubmatic.spark.sql.catalyst.util.{ArrayBasedMapData, ArrayData, DateTimeUtils, GenericArrayData, IntervalUtils}
...
class ObjectExpressionsSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  private def scalaMapSerializerFor[T: TypeTag, U: TypeTag](inputObject: Expression): Expression = {
    import com.pubmatic.spark.sql.catalyst.ScalaReflection._
