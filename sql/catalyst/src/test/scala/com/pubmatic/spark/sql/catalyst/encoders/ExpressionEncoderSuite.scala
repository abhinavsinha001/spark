...
import com.pubmatic.spark.sql.catalyst.{OptionalData, PrimitiveData}
import com.pubmatic.spark.sql.catalyst.analysis.AnalysisTest
import com.pubmatic.spark.sql.catalyst.dsl.plans._
import com.pubmatic.spark.sql.catalyst.expressions.AttributeReference
import com.pubmatic.spark.sql.catalyst.plans.CodegenInterpretedPlanTest
...
import com.pubmatic.spark.util.ClosureCleaner
...
class ExpressionEncoderSuite extends CodegenInterpretedPlanTest with AnalysisTest {
   ...
   *
   * @see com.pubmatic.spark.sql.catalyst.ScalaReflection.cleanUpReflectionObjects
   */
