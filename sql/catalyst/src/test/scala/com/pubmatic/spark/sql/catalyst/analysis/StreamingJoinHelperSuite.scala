...
import com.pubmatic.spark.sql.catalyst.expressions.{Attribute, AttributeReference, AttributeSet}
...
import com.pubmatic.spark.sql.catalyst.plans.logical.{EventTimeWatermark, Filter, LeafNode, LocalRelation}
import com.pubmatic.spark.sql.types.{IntegerType, MetadataBuilder, TimestampType}
