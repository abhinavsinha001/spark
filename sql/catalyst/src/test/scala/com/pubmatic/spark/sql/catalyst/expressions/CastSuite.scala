...
import com.pubmatic.spark.sql.catalyst.analysis.TypeCoercion.numericPrecedence
import com.pubmatic.spark.sql.catalyst.expressions.aggregate.{CollectList, CollectSet}
import com.pubmatic.spark.sql.catalyst.expressions.codegen.CodegenContext
...
abstract class CastSuiteBase extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("null cast") {
    ...
    // follow [[com.pubmatic.spark.sql.catalyst.expressions.Cast.canCast]] logic
