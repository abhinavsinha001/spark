...
package com.pubmatic.spark.graphx
...
class GraphOps[VD: ClassTag, ED: ClassTag](graph: Graph[VD, ED]) extends Serializable {
   ...
   *  [[com.pubmatic.spark.graphx.Graph#subgraph]]
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.PageRank$#runUntilConvergence]]
   */
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.PageRank$#runUntilConvergenceWithOptions]]
   */
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.PageRank$#runWithOptions]]
   */
   ...
   * containing the PageRank and edge attributes the normalized edge weight.
   *
   * @see [[com.pubmatic.spark.graphx.lib.PageRank$#run]]
   */
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.PageRank$#runWithOptionsWithPreviousPageRank]]
   */
   ...
   *
   * @see `com.pubmatic.spark.graphx.lib.ConnectedComponents.run`
   */
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.TriangleCount$#run]]
   */
   ...
   *
   * @see [[com.pubmatic.spark.graphx.lib.StronglyConnectedComponents$#run]]
   */
